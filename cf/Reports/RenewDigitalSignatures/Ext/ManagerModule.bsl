...
Procedure CustomizeReportOptions(Settings, ReportSettings) Export
	...
	ReportSettings.LongDesc = NStr("ru = 'Подписи, срок действия которых должен быть продлен.';
									|en = 'Expiring signatures to be renewed.';");
	
	OptionSettings = ModuleReportsOptions.OptionDetails(Settings, ReportSettings, "rawsignatures");
	OptionSettings.LongDesc = NStr("ru = 'Выводит подписи, у которых нужно определить тип и усовершенствовать согласно настройкам.';
										|en = 'Displays signatures that are subject to enhancement (after their types are determined).';");
	...
	OptionSettings.LongDesc = NStr("ru = 'Выводит подписи, которые требуется усовершенствовать.';
										|en = 'Displays signatures to be enhanced.';");
	OptionSettings.Enabled = AvailableAdvancedSignature And RefineSignaturesAutomatically <> 0;
	
	OptionSettings = ModuleReportsOptions.OptionDetails(Settings, ReportSettings, "RequiredAddArchiveTags");
	OptionSettings.LongDesc = NStr("ru = 'Выводит подписи, в которые пора добавить архивные метки.';
										|en = 'Displays signatures that require archive timestamps.';");
	...
	OptionSettings.LongDesc = NStr("ru = 'Выводит подписи, которые не удалось продлить автоматически.';
										|en = 'Displays signatures that cannot be renewed automatically.';");
