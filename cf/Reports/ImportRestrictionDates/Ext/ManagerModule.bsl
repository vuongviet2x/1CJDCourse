...
Function FirstOption()
	...
	OptionProperties.Insert("Title",
		NStr("ru = 'Даты запрета загрузки данных по информационным базам';
			|en = 'Data import restriction dates by infobases';"));
	
	OptionProperties.Insert("LongDesc",
		NStr("ru = 'Выводит даты запрета загрузки для объектов, сгруппированные по информационным базам.';
...
Function SecondOption()
	...
	If Properties.ShowSections And Not Properties.AllSectionsWithoutObjects Then
		...
		Title = NStr("ru = 'Даты запрета загрузки данных по разделам и объектам';
						|en = 'Data import restriction dates by sections and objects';");
		OptionDetails =
			NStr("ru = 'Выводит даты запрета загрузки, сгруппированные по разделам с объектами.';
	...
	ElsIf Properties.AllSectionsWithoutObjects Then
		...
		Title = NStr("ru = 'Даты запрета загрузки данных по разделам';
						|en = 'Data import restriction dates by sections';");
		OptionDetails =
			NStr("ru = 'Выводит даты запрета загрузки, сгруппированные по разделам.';
				|en = 'Displays data import restriction dates grouped by sections.';");
	Else
		VariantName = "ImportRestrictionDatesByObjectsForInfobases";
		Title = NStr("ru = 'Даты запрета загрузки данных по объектам';
						|en = 'Data import restriction dates by objects';");
		OptionDetails =
			NStr("ru = 'Выводит даты запрета загрузки, сгруппированные по объектам.';
