...
Procedure BeforeAddReportCommands(ReportsCommands, Parameters, StandardProcessing) Export
	...
	If StrStartsWith(Parameters.FormName, "Catalog.AccessGroupProfiles") Then
		...
		If Parameters.FormName = "Catalog.AccessGroupProfiles.Form.ItemForm" Then
			CommandRoles.Presentation    = NStr("ru = 'Права ролей профиля';
												|en = 'Rights of profile roles';");
			CommandProfiles.Presentation = NStr("ru = 'Права профиля';
												|en = 'Rights of profile';");
		Else
			CommandRoles.Presentation    = NStr("ru = 'Права ролей профилей';
												|en = 'Rights of profiles roles';");
			CommandProfiles.Presentation = NStr("ru = 'Права профилей';
												|en = 'Rights of profiles';");
		EndIf;
	Else
		CommandRoles.Presentation = NStr("ru = 'Права ролей и профилей';
...
Procedure CustomizeReportOptions(Settings, ReportSettings) Export
	...
	OptionSettings.LongDesc = NStr("ru = 'Показывает права ролей на объекты метаданных.';
	...
	OptionSettings.LongDesc = NStr("ru = 'Показывает права одной роли на разные объекты метаданных.';
	...
	OptionSettings.LongDesc = NStr("ru = 'Показывает права разных ролей на один объект метаданных.';
	...
	OptionSettings.LongDesc = NStr("ru = 'Показывает подробные права одной роли на один объект метаданных.';
