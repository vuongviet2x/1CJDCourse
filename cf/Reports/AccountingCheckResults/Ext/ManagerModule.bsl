...
Procedure CustomizeReportOptions(Settings, ReportSettings) Export
	...
	OptionSettingsMain.LongDesc = NStr("ru = 'Выводит результаты проверок учета.';
												|en = 'Displays the data integrity check results.';");
	OptionSettingsMain.SearchSettings.Keywords = NStr("ru = 'Отчет о проблемах объекта';
																		|en = 'Report on object issues';");
...
Procedure BeforeAddReportCommands(ReportsCommands, Parameters, StandardProcessing) Export
	...
	Command.Presentation     = NStr("ru = 'Результаты проверки учета';
									|en = 'Data integrity check results';");
