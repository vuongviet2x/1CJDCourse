...
Procedure BeforeAddReportCommands(ReportsCommands, Parameters, StandardProcessing) Export
	...
	VariantPresentation = NStr("ru = 'Права пользователей';
								|en = 'User rights';");
	...
	ElsIf Parameters.FormName = "Catalog.Users.Form.ItemForm"
		...
		VariantPresentation = NStr("ru = 'Права пользователя';
									|en = 'User rights';");
...
Procedure CustomizeReportOptions(Settings, ReportSettings) Export
	...
	OptionSettings.LongDesc = NStr("ru = 'Показывает права пользователей на таблицы информационной базы (можно включить группировку по отчетам).';
										|en = 'Shows user rights to infobase tables (you can enable grouping by reports).';");
	...
	OptionSettings.LongDesc = NStr("ru = 'Показывает права пользователей на таблицы информационной базы.';
										|en = 'Shows user rights to infobase tables.';");
	OptionSettings.Enabled = False;
	
	OptionSettings = ModuleReportsOptions.OptionDetails(Settings, ReportSettings, "UserRightsToTables");
	OptionSettings.LongDesc = NStr("ru = 'Показывает права отдельного пользователя на разные таблицы информационной базы.';
										|en = 'Shows individual user''s rights to different infobase tables.';");
	OptionSettings.Enabled = False;
	
	OptionSettings = ModuleReportsOptions.OptionDetails(Settings, ReportSettings, "UsersRightsToTable");
	OptionSettings.LongDesc = NStr("ru = 'Показывает права разных пользователей на одну таблицу информационной базы.';
										|en = 'Shows different users'' rights to the same infobase table.';");
	OptionSettings.Enabled = False;
	
	OptionSettings = ModuleReportsOptions.OptionDetails(Settings, ReportSettings, "UserRightsToTable");
	OptionSettings.LongDesc = NStr("ru = 'Показывает права одного пользователя на одну таблицу информационной базы с настройками ограничений на уровне записей (RLS).';
										|en = 'Shows user''s rights to one infobase table with record-level restriction settings (RLS).';");
	OptionSettings.Enabled = False;
	
	OptionSettings = ModuleReportsOptions.OptionDetails(Settings, ReportSettings, "UserRightsToReportTables");
	OptionSettings.LongDesc = NStr("ru = 'Показывает права отдельного пользователя на разные таблицы информационной базы, используемые в отдельном отчете.';
										|en = 'Shows individual user''s rights to different infobase tables used in a separate report.';");
	OptionSettings.Enabled = False;
	
	OptionSettings = ModuleReportsOptions.OptionDetails(Settings, ReportSettings, "UsersRightsToReportTables");
	OptionSettings.LongDesc = NStr("ru = 'Показывает права разных пользователей на разные таблицы информационной базы, используемые в отдельном отчете.';
										|en = 'Shows different users'' rights to different infobase tables used in a separate report.';");
	OptionSettings.Enabled = False;
	
	OptionSettings = ModuleReportsOptions.OptionDetails(Settings, ReportSettings, "UserRightsToReportsTables");
	OptionSettings.LongDesc = NStr("ru = 'Показывает права отдельного пользователя на разные таблицы информационной базы, сгруппированные по отчетам.';
										|en = 'Shows individual user''s rights to different infobase tables grouped by reports.';");
	OptionSettings.Enabled = False;
		...
		If AccessKindProperties = Undefined Then
			...
			Else
				String.Presentation = StringFunctionsClientServer.SubstituteParametersToString(
					NStr("ru = 'Настройки прав на %1';
						|en = 'Rights settings for %1';"),
...
Function RepresentationUnknownAccessType()
	...
	Return NStr("ru = 'Неизвестный вид доступа';
				|en = 'Unknown access kind';");
...
Procedure AddTablesWithRestrictionDisabled(TablesWithRestrictionDisabled,
	...
	For Each KeyAndValue In ListRestrictionsProperties Do
		...
		If KeyAndValue.Value.AccessDenied Then
			...
			NewRow.Presentation = "<" + NStr("ru = 'Доступ запрещен';
													|en = 'Access denied';") + ">";
		Else
			NewRow.AccessKind    = Enums.AdditionalAccessValues.AccessAllowed;
			NewRow.Presentation = "<" + NStr("ru = 'Ограничение отключено';
													|en = 'Restriction disabled';") + ">";
		EndIf;
	EndDo;
