...
Procedure OnCreateAtServer(Form, Cancel, StandardProcessing) Export
	...
	If Users.IsFullUser() Then
		...
		Command.Title = NStr("ru = 'Зависимости обработчика';
								|en = 'Handler dependences';");
		Command.ToolTip = NStr("ru = 'Посмотреть зависимости выбранного обработчика';
								|en = 'View dependencies for selected handler';");
		...
		Command.Action  = "Attachable_Command";
		Command.Title = NStr("ru = 'Посмотреть ошибки';
								|en = 'View errors';");
		Command.ToolTip = NStr("ru = 'Посмотреть ошибки в журнале регистрации';
								|en = 'View errors in Event log';");
...
Procedure OnDefineSelectionParameters(Form, SettingProperties) Export
	...
	If SettingProperties.DCField = New DataCompositionField("DataParameters.ProgressProcessing") Then
		SettingProperties.ValuesForSelection.Add(Format(BegOfDay(CurrentSessionDate()), "DLF=D") + " " + "00:00:00", NStr("ru = 'За весь период';
...
Function MetadataTypePresentation(MetadataType)
	...
	Map = New Map;
	Map.Insert("Constant", NStr("ru = 'Константы';
											|en = 'Constants';"));
	Map.Insert("Catalog", NStr("ru = 'Справочники';
											|en = 'Catalogs';"));
	Map.Insert("Document", NStr("ru = 'Документы';
											|en = 'Documents';"));
	Map.Insert("ChartOfCharacteristicTypes", NStr("ru = 'Планы видов характеристик';
														|en = 'Charts of characteristic types';"));
	Map.Insert("ChartOfAccounts", NStr("ru = 'Планы счетов';
											|en = 'Charts of accounts';"));
	Map.Insert("ChartOfCalculationTypes", NStr("ru = 'Планы видов расчета';
													|en = 'Charts of calculation types';"));
	Map.Insert("InformationRegister", NStr("ru = 'Регистры сведений';
													|en = 'Information registers';"));
	Map.Insert("AccumulationRegister", NStr("ru = 'Регистры накопления';
													|en = 'Accumulation registers';"));
	Map.Insert("AccountingRegister", NStr("ru = 'Регистры бухгалтерии';
													|en = 'Accounting registers';"));
	Map.Insert("CalculationRegister", NStr("ru = 'Регистры расчета';
												|en = 'Calculation registers';"));
	Map.Insert("BusinessProcess", NStr("ru = 'Бизнес процессы';
												|en = 'Business processes';"));
	Map.Insert("Task", NStr("ru = 'Задачи';
										|en = 'Tasks';"));
