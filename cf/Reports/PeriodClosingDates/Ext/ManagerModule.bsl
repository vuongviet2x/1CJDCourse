...
Function FirstOption()
	...
	OptionProperties.Insert("Title",
		NStr("ru = 'Даты запрета изменения данных по пользователям';
			|en = 'Period-end closing dates by users';"));
	
	OptionProperties.Insert("LongDesc",
		NStr("ru = 'Выводит даты запрета изменения, сгруппированные по пользователям.';
			|en = 'Displays period-end closing dates grouped by users.';"));
...
Function SecondOption()
	...
	If Properties.ShowSections And Not Properties.AllSectionsWithoutObjects Then
		...
		Title = NStr("ru = 'Даты запрета изменения данных по разделам и объектам';
						|en = 'Period-end closing dates by sections and objects';");
		OptionDetails =
			NStr("ru = 'Выводит даты запрета изменения, сгруппированные по разделам с объектами.';
				|en = 'Displays period-end closing dates grouped by sections with objects.';");
		
	ElsIf Properties.AllSectionsWithoutObjects Then
		VariantName = "PeriodClosingDatesBySectionsForUsers";
		Title = NStr("ru = 'Даты запрета изменения данных по разделам';
						|en = 'Period-end closing dates by sections';");
		OptionDetails =
			NStr("ru = 'Выводит даты запрета изменения, сгруппированные по разделам.';
				|en = 'Displays period-end closing dates grouped by sections.';");
	Else
		VariantName = "PeriodClosingDatesByObjectsForUsers";
		Title = NStr("ru = 'Даты запрета изменения данных по объектам';
						|en = 'Period-end closing dates by objects';");
		OptionDetails =
			NStr("ru = 'Выводит даты запрета изменения, сгруппированные по объектам.';
				|en = 'Displays period-end closing dates grouped by objects.';");
	EndIf;
