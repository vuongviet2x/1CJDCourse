...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Parameters.ColumnsInformation <> Undefined Then
...
Procedure ResetSettings(Command)
	...
	ShowQueryBox(Notification, NStr("ru = 'Установить настройки колонок в первоначальное состояние?';
									|en = 'Do you want to revert to the default column settings?';"), QuestionDialogMode.YesNo);
EndProcedure
...
Procedure SetDataAppearance()
	...
	FilterElement.Use = True;
	ConditionalAppearanceItem.Appearance.SetParameterValue("Text", NStr("ru = 'Стандартное наименование';
																					|en = 'Standard name';"));
