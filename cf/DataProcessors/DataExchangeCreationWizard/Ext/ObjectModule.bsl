...
Procedure ExternalConnectionSetUpNewDataExchange(Cancel, 
	...
	Try
		...
		If Cancel Then
			Raise(NStr("ru = 'При создании настройки синхронизации данных возникли ошибки.';
									|en = 'Error creating data synchronization settings.';"));
		EndIf;
...
Procedure ImportWizardParameters(Cancel, XMLLine) Export
	...
	If Common.DataSeparationEnabled()
		...
		ErrorMessageStringField = NStr("ru = 'Синхронизация данных с этой программой в режиме сервиса не предусмотрена.';
