...
Procedure UpdateAdditionalReportsAndDataProcessors(Command)
	ExecuteCommandInBackground("UpdateAdditionalReportsAndDataProcessors", NStr("ru = 'Обновление дополнительных отчетов и обработок';
																		|en = 'Grouping additional reports and data processors';"));
EndProcedure
