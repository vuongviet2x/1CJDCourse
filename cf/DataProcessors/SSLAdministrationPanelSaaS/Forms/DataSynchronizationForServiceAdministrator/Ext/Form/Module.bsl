...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not Common.SubsystemExists("CloudTechnology") Then
		Raise NStr("ru = 'Не поддерживается функциональность администрирования синхронизации данных в модели сервиса.';
								|en = 'Administration functionality of data synchronization is not supported in SaaS.';");
	EndIf;
