...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Parameters.User <> Undefined Then
		...
		Title = NStr("ru = 'Настройки пользователя';
						|en = 'User settings';");
	Else
...
Procedure UserRefStartChoice(Item, ChoiceData, StandardProcessing)
	...
	If UseExternalUsers Then
		...
		UsersTypeSelection.Add("ExternalUsers", NStr("ru = 'Внешние пользователи';
																	|en = 'External users';"));
		UsersTypeSelection.Add("Users",        NStr("ru = 'Пользователи';
																	|en = 'Users';"));
...
Procedure SettingsBeforeDelete(Item, Cancel)
	...
	QueryText = NStr("ru = 'Очистить выбранные настройки?';
...
Procedure CopyAllSettings(Command)
	...
	SettingsToCopy.Add("ReportsSettings",      NStr("ru = 'Настройки отчетов';
																|en = 'Report settings';"));
	SettingsToCopy.Add("InterfaceSettings2", NStr("ru = 'Настройки внешнего вида';
																|en = 'Interface settings';"));
	SettingsToCopy.Add("FormData",            NStr("ru = 'Данные форм';
																|en = 'Form data';"));
	SettingsToCopy.Add("PersonalSettings", NStr("ru = 'Персональные настройки';
																|en = 'Personal settings';"));
	SettingsToCopy.Add("Favorites",             NStr("ru = 'Избранное';
																|en = 'Favorites';"));
	SettingsToCopy.Add("PrintSettings",       NStr("ru = 'Настройки печати';
																|en = 'Print settings';"));
	SettingsToCopy.Add("OtherUserSettings",
		NStr("ru = 'Настройки дополнительных отчетов и обработок';
			|en = 'Additional report and data processor settings';"));
...
Procedure Clear(Command)
	...
	If SettingsTree.SelectedRows.Count() = 0 Then
		...
		ShowMessageBox(,NStr("ru = 'Выберите настройки, которые требуется удалить.';
									|en = 'Select the settings that you want to delete.';"));
		Return;
		
	EndIf;
	
	Notification = New NotifyDescription("ClearCompletion", ThisObject, SettingsTree);
	QueryText = NStr("ru = 'Очистить выделенные настройки?';
						|en = 'Do you want to clear the selected settings?';");
...
Procedure ClearAllSettings(Command)
	...
	QueryText = StringFunctionsClientServer.SubstituteParametersToString(
		NStr("ru = 'Очистить все настройки у пользователя ""%1""?';
			|en = 'Do you want to clear all settings for user ""%1""?';"), String(UserRef));
	
	QuestionButtons = New ValueList;
	QuestionButtons.Add("Clear", NStr("ru = 'Очистить';
											|en = 'Clear';"));
	QuestionButtons.Add("Cancel",   NStr("ru = 'Отмена';
											|en = 'Cancel';"));
...
Procedure ClearObsoleteSettings(Command)
	...
	QueryText = StringFunctionsClientServer.SubstituteParametersToString(
		NStr("ru = 'Очистить устаревшие настройки у пользователя ""%1""?';
			|en = 'Clear obsolete settings for the ""%1"" users?';"), String(UserRef));
	
	QuestionButtons = New ValueList;
	QuestionButtons.Add("Clear", NStr("ru = 'Очистить';
											|en = 'Clear the settings.';"));
	QuestionButtons.Add("Cancel",   NStr("ru = 'Отмена';
											|en = 'Cancel';"));
...
Procedure ClearReportAndInterfaceSettings(Command)
	...
	QueryText = StringFunctionsClientServer.SubstituteParametersToString(
		NStr("ru = 'Очистить все настройки отчетов и внешнего вида у пользователя ""%1""?';
			|en = 'Do you want to clear all interface and report settings for user ""%1""?';"),
		String(UserRef));
...
Procedure ClearSettingsForAllUsers(Command)
	...
	QuestionButtons = New ValueList;
	QuestionButtons.Add("ClearAll", NStr("ru = 'Очистить все';
												|en = 'Clear all';"));
	QuestionButtons.Add("Cancel",      NStr("ru = 'Отмена';
												|en = 'Cancel';"));
...
Procedure ClearObsoleteSettingsOfAllUsers(Command)
	...
	QueryText =
		NStr("ru = 'Сейчас будут очищены устаревшие настройки всех пользователей.
		           |Продолжить?';
					|en = 'Obsolete settings for all users will be cleared.
					|Continue?';");
...
Procedure CalculateSettingsCount()
	...
	If SettingsCount <> 0 Then
		Items.ReportSettingsPage.Title =
			StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Настройки отчетов (%1)';
					|en = 'Report settings (%1)';"), SettingsCount);
	Else
		Items.ReportSettingsPage.Title = NStr("ru = 'Настройки отчетов';
															|en = 'Report settings';");
	EndIf;
	...
	If SettingsCount <> 0 Then
		Items.InterfacePage.Title =
			StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Внешний вид (%1)';
					|en = 'Interface settings (%1)';"), SettingsCount);
	Else
		Items.InterfacePage.Title = NStr("ru = 'Внешний вид';
													|en = 'Interface';");
	EndIf;
	...
	If SettingsCount <> 0 Then
		Items.OtherSettingsPage.Title =
			StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Прочие настройки (%1)';
					|en = 'Other settings (%1)';"), SettingsCount);
	Else
		Items.OtherSettingsPage.Title = NStr("ru = 'Прочие настройки';
															|en = 'Other settings';");
	EndIf;
...
Procedure Attachable_ExecuteNotifyProcessing()
	...
	NotificationText1     = NStr("ru = 'Копирование настроек';
								|en = 'Copy settings';");
	...
	If Parameter.CopyAll Then
		...
		If SettingsArray.Count() = 7 Then
			NotificationComment = StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Скопированы все настройки %1';
					|en = 'All settings are copied to %1.';"), SettingsCopiedToNote);
		Else
			NotificationComment = StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = '%1 скопированы %2';
					|en = '%1 copied to %2';"), SettingsNames, SettingsCopiedToNote);
		EndIf;
		...
		If Report <> Undefined Then
			QueryText = NStr("ru = 'Не все варианты отчетов и настройки были скопированы.';
								|en = 'Some report options and settings are not copied.';");
...
Procedure ClearSettingsForAllUsersCompletion(Response, AdditionalParameters) Export
	...
	ShowUserNotification(NStr("ru = 'Очистка настроек';
										|en = 'Clear settings';"), ,
		NStr("ru = 'Очищены все настройки всех пользователя';
			|en = 'All settings of all users are cleared.';"), PictureLib.DialogInformation);
...
Procedure ClearObsoleteSettingsOfAllUsersCompletion(Response, AdditionalParameters) Export
	...
	ShowUserNotification(NStr("ru = 'Очистка настроек';
										|en = 'Clear settings';"), ,
		NStr("ru = 'Очищены устаревшие настройки всех пользователя';
			|en = 'Obsolete settings are cleared for all users';"), PictureLib.DialogInformation);
...
Procedure ClearAllSettingsCompletion(Response, AdditionalParameters) Export
	...
	ExplanationText = NStr("ru = 'Очищены все настройки пользователя ""%1""';
							|en = 'All settings of user ""%1"" are cleared.';");
	ExplanationText = StringFunctionsClientServer.SubstituteParametersToString(ExplanationText, UserRef);
	ShowUserNotification(NStr("ru = 'Очистка настроек';
										|en = 'Clear settings';"), , ExplanationText, PictureLib.DialogInformation);
...
Procedure ClearObsoleteSettingsCompletion(Response, AdditionalParameters) Export
	...
	ExplanationText = NStr("ru = 'Очищены устаревшие настройки пользователя ""%1""';
							|en = 'Obsolete settings are cleared for the ""%1"" user';");
	ExplanationText = StringFunctionsClientServer.SubstituteParametersToString(ExplanationText, UserRef);
	ShowUserNotification(NStr("ru = 'Очистка настроек';
										|en = 'Clear settings';"), , ExplanationText, PictureLib.DialogInformation);
...
Procedure ClearReportAndInterfaceSettingsCompletion(Response, AdditionalParameters) Export
	...
	ExplanationText = NStr("ru = 'Очищены все настройки отчетов и внешнего вида у пользователя ""%1""';
							|en = 'All interface and report settings of user ""%1"" are cleared.';");
...
Procedure NotifyDeletion(SettingsCount, SettingName1 = Undefined, UsersCount = Undefined)
	...
	If SettingsCount = 1
	   And UsersCount = Undefined Then
		...
		ExplanationText = StringFunctionsClientServer.SubstituteParametersToString(
			NStr("ru = '""%1"" очищена пользователю ""%2""';
				|en = '""%1"" cleared for user ""%2.""';"), SettingName1, String(UserRef));
		
	ElsIf UsersCount = Undefined Then
		ExplanationText = StringFunctionsClientServer.SubstituteParametersToString(
			NStr("ru = 'Очищено %1 пользователю ""%2""';
				|en = '%1 cleared for user ""%2.""';"), SubjectInWords, String(UserRef));
	EndIf;
	...
	If UsersCount <> Undefined Then
		...
		If SettingsCount = 1 Then
			ExplanationText = StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = '""%1"" очищена %2';
					|en = '""%1"" cleared for %2';"), SettingName1, ClearSettingsForNote);
		Else
			ExplanationText = StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Очищено %1 %2';
					|en = '%1 cleared for %2';"), SubjectInWords, ClearSettingsForNote);
		EndIf;
...
Procedure CopySettings()
	...
	If SettingsTree.SelectedRows.Count() = 0 Then
		ShowMessageBox(,
			NStr("ru = 'Выберите настройки, которые требуется скопировать.';
				|en = 'Select the settings to copy.';"));
		Return;
