...
Function AllFormSettings(UserName)
	...
	FormsList.Add("ExternalDataProcessor.StandardEventLog.Form.EventsJournal", 
		PrefixOfStandardForms() + "." + NStr("ru = 'Журнал регистрации';
												|en = 'Event log';") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardEventLog.Form.EventForm", 
		PrefixOfStandardForms() + "." + NStr("ru = 'Журнал регистрации, Событие';
												|en = 'Event log, Event';") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardEventLog.Form.EventsJournalFilter", 
		PrefixOfStandardForms() + "." + NStr("ru = 'Журнал регистрации, Настройка отбора событий';
												|en = 'Event log, Event filter settings';") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardFindByRef.Form.MainForm", 
		PrefixOfStandardForms() + "." + NStr("ru = 'Поиск ссылок на объект';
												|en = 'Find references to objects';") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardFullTextSearchManagement.Form.MainForm", 
		PrefixOfStandardForms() + "." + NStr("ru = 'Управление полнотекстовым поиском';
												|en = 'Full-text search management';") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardDocumentsPosting.Form.MainForm", 
		PrefixOfStandardForms() + "." + NStr("ru = 'Проведение документов';
												|en = 'Post documents';") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardDeleteMarkedObjects.Form.Form", 
		PrefixOfStandardForms() + "." + NStr("ru = 'Удаление помеченных объектов';
												|en = 'Delete marked objects';") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardExternalDataSourceManagement.Form.Form", 
		PrefixOfStandardForms() + "." + NStr("ru = 'Управление внешними источниками данных';
												|en = 'External data source management';") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardTotalsManagement.Form.MainForm", 
		PrefixOfStandardForms() + "." + NStr("ru = 'Управление итогами';
												|en = 'Totals management';") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardActiveUsers.Form.ActiveUsersListForm", 
		PrefixOfStandardForms() + "." + NStr("ru = 'Активные пользователи';
												|en = 'Active users';") , False, PictureLib.Form);
...
Function MetadataObjectForms1()
	...
	FillMetadataObjectForms(Metadata.FilterCriteria, "FilterCriterion", NStr("ru = 'Критерий отбора';
																						|en = 'Filter criterion';"),
		StandardFormNames, PictureLib.FilterCriterion, FormsList);
		
	StandardFormNames = New ValueList;
	FillMetadataObjectForms(Metadata.SettingsStorages, "SettingsStorage", NStr("ru = 'Хранилище настроек';
																							|en = 'Settings storage';"),
	...
	FillMetadataObjectForms(Metadata.Catalogs, "Catalog", NStr("ru = 'Справочник';
																				|en = 'Catalog';"),
	...
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm_", "ChoiceForm");
	FillMetadataObjectForms(Metadata.Documents, "Document", NStr("ru = 'Документ';
																			|en = 'Document';"),
		StandardFormNames, PictureLib.Document, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("Form");
	FillMetadataObjectForms(Metadata.DocumentJournals, "DocumentJournal", NStr("ru = 'Журнал документов';
																							|en = 'Document journal';"),
	...
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm_", "ChoiceForm");
	FillMetadataObjectForms(Metadata.Enums, "Enum", NStr("ru = 'Перечисление';
																					|en = 'Enumeration';"),
	...
	FillMetadataObjectForms(Metadata.Reports, "Report", NStr("ru = 'Отчет';
																		|en = 'Report';"),
		StandardFormNames, PictureLib.Report, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("Form");
	FillMetadataObjectForms(Metadata.DataProcessors, "DataProcessor", NStr("ru = 'Обработка';
																			|en = 'Data processor';"),
	...
	StandardFormNames.Add("ChoiceForm_", "ChoiceForm");
	StandardFormNames.Add("FolderChoiceForm", "GroupChoiceForm");
	FillMetadataObjectForms(Metadata.ChartsOfCharacteristicTypes, "ChartOfCharacteristicTypes", NStr("ru = 'План видов характеристик';
	...
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm_", "ChoiceForm");
	FillMetadataObjectForms(Metadata.ChartsOfAccounts, "ChartOfAccounts", NStr("ru = 'План счетов';
	...
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm_", "ChoiceForm");
	FillMetadataObjectForms(Metadata.ChartsOfCalculationTypes, "ChartOfCalculationTypes", NStr("ru = 'План видов расчета';
	...
	StandardFormNames.Add("ListForm");
	FillMetadataObjectForms(Metadata.InformationRegisters, "InformationRegister", NStr("ru = 'Регистр сведений';
																							|en = 'Information register';"),
		StandardFormNames, PictureLib.InformationRegister, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("ListForm");
	FillMetadataObjectForms(Metadata.AccumulationRegisters, "AccumulationRegister", NStr("ru = 'Регистр накопления';
																								|en = 'Accumulation register';"),
		StandardFormNames, PictureLib.AccumulationRegister, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("ListForm");
	FillMetadataObjectForms(Metadata.AccountingRegisters, "AccountingRegister", NStr("ru = 'Регистр бухгалтерии';
																								|en = 'Accounting register';"),
		StandardFormNames, PictureLib.AccountingRegister, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("ListForm");
	FillMetadataObjectForms(Metadata.CalculationRegisters, "CalculationRegister", NStr("ru = 'Регистр расчета';
	...
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm_", "ChoiceForm");
	FillMetadataObjectForms(Metadata.BusinessProcesses, "BusinessProcess", NStr("ru = 'Бизнес-процесс';
																						|en = 'Business process';"),
	...
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm_", "ChoiceForm");
	FillMetadataObjectForms(Metadata.Tasks, "Task", NStr("ru = 'Задача';
																		|en = 'Task';"),
	...
	StandardFormNames.Add("RecordForm");
	StandardFormNames.Add("ListForm");
	FillMetadataObjectForms(Metadata.ExternalDataSources, "ExternalDataSource", NStr("ru = 'Внешние источники данных';
...
Procedure AddFormTypeToPresentation(Object, Form, FormName)
	...
	If Form = ObjectValues.DefaultListForm Then
		FormName = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = '%1 (список)';
																				|en = '%1 (list)';"), FormName);
	ElsIf Form = ObjectValues.DefaultChoiceForm Then
		FormName = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = '%1 (выбор)';
																				|en = '%1 (choice)';"), FormName);
	ElsIf Form = ObjectValues.DefaultFolderForm Then
		FormName = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = '%1 (группа)';
																				|en = '%1 (group)';"), FormName);
	ElsIf Form = ObjectValues.DefaultFolderChoiceForm Then
		FormName = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = '%1 (выбор группы)';
																				|en = '%1 (select group)';"), FormName);
	EndIf;
...
Function CreateReportOnCopyingSettings(NotCopiedReportSettings,
	...
	If NotCopiedReportSettings.Count() <> 0 Then
		HeaderArea_ = TabTemplate.GetArea("Title");
		HeaderArea_.Parameters.LongDesc = 
			NStr("ru = 'У следующих пользователей недостаточно прав на отчеты:';
				|en = 'The following users have insufficient access rights for reports:';");
		TabDoc.Put(HeaderArea_);
...
Procedure FillInterfaceSettingsList(Parameters)
	...
	Setting = NStr("ru = 'Командный интерфейс и начальная страница';
					|en = 'Command interface and home page';");
...
Procedure FillOtherSettingsList(Parameters)
	...
	If Keys.Count() > 0 Then
		Setting = NStr("ru = 'Персональные настройки';
	...
	If HasPrintSettings Then
		Setting = NStr("ru = 'Настройки печати табличных документов';
						|en = 'Spreadsheet document print settings';");
	...
	If OtherKeys.Count() <> 0 Then
		Setting = NStr("ru = 'Прочие настройки';
						|en = 'Other settings';");
...
Procedure AddDesktopAndCommandInterfaceSettings(Parameters, SettingsTree)
	...
	If AllSettingsKeys.Count() > 0 Then
		...
		NewInterfaceRow.Setting = NStr("ru = 'Командный интерфейс и начальная страница';
												|en = 'Command interface and home page';");
		NewInterfaceRow.Picture = PictureLib.Picture;
		NewInterfaceRow.RowType = NStr("ru = 'Командный интерфейс и начальная страница';
												|en = 'Command interface and home page';");
	...
	If InterfaceSettingsKeys.Count() > 0 Then
		...
		NewSubordinateInterfaceRow = NewInterfaceRow.Rows.Add();
		NewSubordinateInterfaceRow.Setting = NStr("ru = 'Командный интерфейс';
													|en = 'Command interface';");
		NewSubordinateInterfaceRow.Picture = PictureLib.Picture;
