...
Procedure Print(ObjectsArray, PrintParameters, PrintFormsCollection, PrintObjects, OutputParameters) Export
	...
	PrintForm = PrintManagement.PrintFormInfo(PrintFormsCollection, "GoodsReceipt1");
	If PrintForm <> Undefined Then
		TemplateSynonym = "Goods receipt 1";
		PrintForm.SpreadsheetDocument = PrintGoodsReceipt(ObjectsArray, PrintObjects, "PF_MXL_GoodsReceipt1", TemplateSynonym);
		PrintForm.TemplateSynonym = TemplateSynonym;
		PrintForm.FullTemplatePath = "Document._DemoGoodsReceipt.PF_MXL_GoodsReceipt1";
	EndIf;
