...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Common.IsMobileClient() Then
		...
		CommonClientServer.SetFormItemProperty(Items, "Presentation", "InputHint", NStr("ru = 'Представление';
																														|en = 'Presentation';"));
...
Function SelectionResult()
	...
	Common.CommonSettingsStorageSave("DataProcessor.ContactInformationInput.Form.PhoneInput", "CountryAndCityCodes", Codes, NStr("ru = 'Коды страны и города';
																																				|en = 'Codes of country and city.';"));
...
Procedure NotifyFillErrors(ErrorList)
	...
	If ErrorList.Count()=0 Then
		ShowMessageBox(, NStr("ru = 'Телефон введен корректно.';
