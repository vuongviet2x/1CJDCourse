...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not ValueIsFilled(ContactInformationKind) Then
		Raise NStr("ru = 'Команда не может быть выполнена для указанного объекта из-за некорректного внедрения контактной информации.';
								|en = 'Cannot execute command for the object. Contact information is invalid.';");
	EndIf;
