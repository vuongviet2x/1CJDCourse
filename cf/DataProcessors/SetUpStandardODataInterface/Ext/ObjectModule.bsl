...
Function InitializeDataToSetUpStandardODataInterfaceComposition() Export
	...
	AddTreeRootRow("Constant", NStr("ru = 'Константы';
													|en = 'Constants';"), 1, PictureLib.Constant);
	AddTreeRootRow("Catalog", NStr("ru = 'Справочники';
													|en = 'Catalogs';"), 2, PictureLib.Catalog);
	AddTreeRootRow("Document", NStr("ru = 'Документы';
													|en = 'Documents';"), 3, PictureLib.Document);
	AddTreeRootRow("DocumentJournal", NStr("ru = 'Журналы документов';
															|en = 'Document journals';"), 4, PictureLib.DocumentJournal);
	AddTreeRootRow("Enum", NStr("ru = 'Перечисление';
														|en = 'Enumeration';"), 5, PictureLib.Enum);
	AddTreeRootRow("ChartOfCharacteristicTypes", NStr("ru = 'Планы видов характеристик';
																|en = 'Charts of characteristic types';"), 6, PictureLib.ChartOfCharacteristicTypes);
	AddTreeRootRow("ChartOfAccounts", NStr("ru = 'Планы счетов';
													|en = 'Charts of accounts';"), 7, PictureLib.ChartOfAccounts);
	AddTreeRootRow("ChartOfCalculationTypes", NStr("ru = 'Планы видов расчета';
															|en = 'Charts of calculation types';"), 8, PictureLib.ChartOfCalculationTypes);
	AddTreeRootRow("InformationRegister", NStr("ru = 'Регистры сведений';
														|en = 'Information registers';"), 9, PictureLib.InformationRegister);
	AddTreeRootRow("AccumulationRegister", NStr("ru = 'Регистры накопления';
															|en = 'Accumulation registers';"), 10, PictureLib.AccumulationRegister);
	AddTreeRootRow("AccountingRegister", NStr("ru = 'Регистры бухгалтерии';
															|en = 'Accounting registers';"), 11, PictureLib.AccountingRegister);
	AddTreeRootRow("CalculationRegister", NStr("ru = 'Регистры расчета';
														|en = 'Calculation registers';"), 12, PictureLib.CalculationRegister);
	AddTreeRootRow("BusinessProcess", NStr("ru = 'Бизнес-процессы';
														|en = 'Business processes';"), 13, PictureLib.BusinessProcess);
	AddTreeRootRow("Task", NStr("ru = 'Задачи';
												|en = 'Tasks';"), 14, PictureLib.Task);
	AddTreeRootRow("ExchangePlan", NStr("ru = 'Планы обмена';
