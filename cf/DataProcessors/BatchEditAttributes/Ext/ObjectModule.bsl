...
Function ExternalDataProcessorInfo() Export
	...
	If SubsystemExists("StandardSubsystems.AdditionalReportsAndDataProcessors") Then
		...
		NewCommand.Presentation = NStr("ru = 'Групповое изменение реквизитов';
	...
	For Each AttributeDetails In AvailableAttributes Do
		...
		Else
			ErrorText = SubstituteParametersToString(
				NStr("ru = 'Реквизит ""%1"" не поддерживается в выражениях';
					|en = 'Expressions do not support the ""%1"" attribute';"), AttributeDetails.Presentation);
			Raise ErrorText;
		EndIf;
...
Function RunObjectsChangeInMultipleThreads(Parameters, ObjectsToProcess, ChangeResult,
	...
	ExecutionParameters.BackgroundJobDescription = NStr("ru = 'Групповое изменение реквизитов';
															|en = 'Bulk attribute edit';");
