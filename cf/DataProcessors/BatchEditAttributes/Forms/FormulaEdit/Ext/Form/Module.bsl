...
Procedure BeforeClose(Cancel, Exit, WarningText, StandardProcessing)
	...
	ShowQueryBox(New NotifyDescription("BeforeCloseCompletion", ThisObject), NStr("ru = 'Данные были изменены. Сохранить изменения?';
...
Function GetStandardOperatorsTree()
	...
	OperatorsGroup = AddOperatorsGroup(Tree, NStr("ru = 'Разделители';
															|en = 'Separators';"));
	...
	AddOperator(Tree, OperatorsGroup, ",", " + "", "" + ");
	AddOperator(Tree, OperatorsGroup, ".", " + "". "" + ");
	AddOperator(Tree, OperatorsGroup, NStr("ru = 'Пробел';
													|en = 'Whitespace';"), " + "" "" + ");
	AddOperator(Tree, OperatorsGroup, "(", " + "" ("" + ");
	AddOperator(Tree, OperatorsGroup, ")", " + "") "" + ");
	AddOperator(Tree, OperatorsGroup, """", " + """""""" + ");
	
	OperatorsGroup = AddOperatorsGroup(Tree, NStr("ru = 'Операторы';
															|en = 'Operators';"));
	...
	OperatorsGroup = AddOperatorsGroup(Tree, NStr("ru = 'Логические операторы и константы';
	...
	OperatorsGroup = AddOperatorsGroup(Tree, NStr("ru = 'Числовые функции';
	...
	OperatorsGroup = AddOperatorsGroup(Tree, NStr("ru = 'Строковые функции';
															|en = 'String functions';"));
	...
	OperatorsGroup = AddOperatorsGroup(Tree, NStr("ru = 'Прочие функции';
															|en = 'Other functions';"));
	
	AddOperator(Tree, OperatorsGroup, NStr("ru = 'Условие';
													|en = 'Condition';"), "?(,,)", 3);
	...
	If ValueIsFilled(Formula) Then
		If CheckFormula(Formula, Operands) Then
			ShowUserNotification(
				NStr("ru = 'В формуле ошибок не обнаружено';
					|en = 'Formula is valid.';"),
				,
				,
