...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	MasterApplicationExternalAddress = Constants.MasterApplicationExternalAddress.Get();
...
&AtClient
Procedure QueriesProcessingHeaderDecorationURLProcessing(Item, FormattedStringURL, StandardProcessing)
	
	If FormattedStringURL = "internal://sm" Then
		
		StandardProcessing = False;
		FileSystemClient.OpenURL(MasterApplicationExternalAddress + "?N=" + UserName() + "&C=PermissionRequest" + String(IDOfPackage));
