...
Function GenerateToDoListInBackground()
	...
	ExecutionParameters.BackgroundJobDescription = NStr("ru = 'Обновление списка текущих дел';
															|en = 'Update to-do list';");
	...
	ElsIf Result.Status = "Completed2" Then
		...
		If OutputNotifications Then
			...
			For Each ToDoWithNotification In ToDoItemsWithNotification Do
				...
				ShowUserNotification(NStr("ru = 'Текущие дела';
													|en = 'To-do list';"),
...
Procedure CreateCaption(ToDoItem, Var_Group, SectionCollapsed)
	...
	Item.ToolTip = NStr("ru = 'Развернуть/свернуть раздел';
							|en = 'Expand or collapse the section.';");
