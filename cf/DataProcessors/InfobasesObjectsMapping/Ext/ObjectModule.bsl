...
Procedure ExecuteDataImportForInfobase(Cancel, TablesToImport) Export
	...
	If DataExchangeDataProcessor.FlagErrors() Then
		NString = NStr("ru = 'При загрузке сообщения обмена возникли ошибки: %1';
						|en = 'Errors occurred while importing the exchange message: %1';");
	...
	For Each Item In TableFieldsList Do
		...
		If Attribute = Undefined Then
			Raise StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Для объекта метаданных ""%1"" не определен реквизит с именем ""%2""';
					|en = 'The %2 attribute is not defined for the %1 metadata object.';"),
