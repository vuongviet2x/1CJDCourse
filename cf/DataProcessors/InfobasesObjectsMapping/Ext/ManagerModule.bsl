...
Function ObjectMappingResult(Parameters)
	...
	If Parameters.FormAttributes.ApplyOnlyUnapprovedRecordsTable Then
		...
		If Cancel Then
			Raise NStr("ru = 'Возникли ошибки в процессе сопоставления объектов.';
									|en = 'Errors occurred during object mapping.';");
		EndIf;
...
Function AutomaticObjectMappingResult(Parameters)
	...
	If Cancel Then
		Raise NStr("ru = 'Возникли ошибки в процессе автоматического сопоставления объектов.';
								|en = 'Errors occurred during automatic object mapping.';");
	EndIf;
