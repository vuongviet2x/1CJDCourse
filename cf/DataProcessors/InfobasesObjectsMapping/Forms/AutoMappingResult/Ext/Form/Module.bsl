...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not Parameters.Property("ExchangeMessageFileName") Then
		...
		NString = NStr("ru = 'Форма не может быть открыта интерактивно.';
						|en = 'The form cannot be opened interactively.';");
...
Procedure BeforeClose(Cancel, Exit, WarningText, StandardProcessing)
	...
	If Exit Then
		Return;
	EndIf;
	ShowMessageBox(, NStr("ru = 'Форма содержит данные автоматического сопоставления. Действие отменено.';
									|en = 'The form contains automatic mapping data. The action is canceled.';"));
...
Function BackgroundJobStartAtServer(Cancel)
	...
	ExecutionParameters.BackgroundJobDescription = NStr("ru = 'Автоматическое сопоставление объектов';
															|en = 'Automatic object mapping';");
...
Procedure RecordError(DetailErrorDescription)
	WriteLogEvent(
		NStr("ru = 'Помощник сопоставления объектов.Автоматическое сопоставление';
			|en = 'Object mapping wizard.Automatic object mapping';", Common.DefaultLanguageCode()),
		EventLogLevel.Error,
		,
