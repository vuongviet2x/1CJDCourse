...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If ClearAndClose Then
		...
		Items.AttentionLabel.Title =
			NStr("ru = 'Отложенное обновление <a href = %1>не завершено</a>. Рекомендуется завершить обновление и выполнить очистку перед обновлением конфигурации.';
...
Procedure Clear(Command)
	...
	QueryText =
		NStr("ru = 'Отложенное обновление не завершено.
	...
	AdditionalParameters.Title = NStr("ru = 'Очистка устаревших данных';
...
Procedure CleanUpPlan(Command)
	...
	TextDocument.Show(NStr("ru = 'План очистки устаревших данных';
...
Procedure SetConditionalAppearance()
	...
	Item.Appearance.SetParameterValue("Text", NStr("ru = 'Общие данные';
																|en = 'Shared data';"));
...
Function StartUpdateAtServer()
	...
	Items.LongRunningOperationText.Title =
		NStr("ru = 'Обновление списка устаревших данных ...';
	...
	ExecutionParameters.BackgroundJobDescription = NStr("ru = 'Обновление списка устаревших данных';
...
Function StartCleanUpAtServer()
	...
	Items.Pages.CurrentPage = Items.TimeConsumingOperationPage;
	Items.LongRunningOperationText.Title =
		NStr("ru = 'Очистка устаревших данных ...';
	...
	ExecutionParameters = TimeConsumingOperations.BackgroundExecutionParameters(UUID);
	ExecutionParameters.WaitCompletion = 0;
	ExecutionParameters.BackgroundJobDescription = NStr("ru = 'Очистка устаревших данных';
															|en = 'Clear obsolete data';");
