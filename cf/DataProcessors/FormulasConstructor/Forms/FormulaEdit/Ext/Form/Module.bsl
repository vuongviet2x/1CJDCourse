...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	ParametersForAddingAListOfFields.HintForEnteringTheSearchString = NStr("ru = 'Найти операнд...';
																	|en = 'Find operand…';");
	...
	ParametersForAddingAListOfFields.HintForEnteringTheSearchString = NStr("ru = 'Найти оператор или функцию...';
...
Procedure CheckFormula(Command)
	...
	ExecuteCheck();
	ShowMessageBox(, NStr("ru = 'Проверка выполнена успешно.';
									|en = 'Check succeeded.';"));
...
Function TheTextOfTheErrorMessageWhenCheckingTheFormula(ErrorText)
	...
	MessageTemplate = NStr("ru = 'Введенная формула некорректная:
	|%1';
	|en = 'The entered formula is incorrect:
	|%1';");
