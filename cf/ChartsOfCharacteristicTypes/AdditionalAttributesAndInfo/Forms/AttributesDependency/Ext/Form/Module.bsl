...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Title = NStr("ru = '%1 дополнительного реквизита ""%2""';
					|en = '%1 of ""%2"" additional attribute';");
	If PropertyToConfigure = "Available" Then
		PropertyPresentation = NStr("ru = 'Доступность';
									|en = 'Availability';");
	ElsIf PropertyToConfigure = "RequiredToFill" Then
		PropertyPresentation = NStr("ru = 'Обязательность заполнения';
									|en = '""Required"" property';");
	Else
		PropertyPresentation = NStr("ru = 'Видимость';
									|en = 'Visibility';");
	EndIf;
	...
	If Not ValueIsFilled(PropertiesSet) Then
		ExceptionText = NStr("ru = 'Настройка видимости, доступности и обязательности заполнения
			              |доступна только при открытии дополнительного реквизита
			              |из списка ""Дополнительные реквизиты"".';
							|en = 'You can configure attribute visibility, availability, and whether it is required
...
Procedure SetConditionalAppearance()
	...
	ConditionalAppearanceItem.Appearance.SetParameterValue("Text", NStr("ru = 'Не равно';
																					|en = 'Not equal to';"));
	...
	ConditionalAppearanceItem.Appearance.SetParameterValue("Text", NStr("ru = 'Равно';
																					|en = 'Equal to';"));
	...
	ConditionalAppearanceItem.Appearance.SetParameterValue("Text", NStr("ru = 'Не заполнено';
																					|en = 'Empty';"));
	...
	ConditionalAppearanceItem.Appearance.SetParameterValue("Text", NStr("ru = 'Заполнено';
																					|en = 'Filled';"));
	...
	ConditionalAppearanceItem.Appearance.SetParameterValue("Text", NStr("ru = 'В списке';
																					|en = 'In list';"));
	...
	ConditionalAppearanceItem.Appearance.SetParameterValue("Text", NStr("ru = 'Не в списке';
																					|en = 'Not in list';"));
