...
Function GetExchangeServiceWSProxy() Export
	...
	If Result = Undefined Then
		Raise NStr("ru = 'Ошибка получения web-сервиса обмена данными управляющего приложения.';
								|en = 'An error occurred when getting the data exchange web service from the managing application.';");
	EndIf;
