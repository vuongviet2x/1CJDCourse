...
Function SynchronizationSetupStep1Presentation()
	...
	Return NStr("ru = 'Настройка синхронизации, шаг 1.';
				|en = 'Synchronization setup, step 1.';");
	
EndFunction

Function SynchronizationSetupStep2Presentation()
	
	Return NStr("ru = 'Настройка синхронизации, шаг 2.';
				|en = 'Synchronization setup, step 2.';");
	
EndFunction

Function ExchangeMessageImportPresentation()
	
	Return NStr("ru = 'Загрузка сообщения обмена.';
				|en = 'Importing an exchange message.';");
	
EndFunction

Function CorrespondentDataGettingPresentation()
	
	Return NStr("ru = 'Получение данных корреспондента.';
				|en = 'Receiving data from the peer infobase.';");
	
EndFunction

Function GettingCommonDataOfCorrespondentNodePresentation()
	
	Return NStr("ru = 'Получение общих данных узлов корреспондента.';
				|en = 'Receiving common data from peer infobase nodes.';");
	
EndFunction

Function GettingCorrespondentAccountingParametersPresentation()
	
	Return NStr("ru = 'Получение параметров учета корреспондента.';
				|en = 'Receiving accounting settings from the peer infobase.';");
