...
Procedure InterfaceSetup(InterfaceSettings5) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.InterfaceSetup(InterfaceSettings5);
	// _Demo Example End
...
Procedure OnFillPeriodClosingDatesSections(Sections) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnFillPeriodClosingDatesSections(Sections);
	// _Demo Example End
...
Procedure FillDataSourcesForPeriodClosingCheck(DataSources) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.FillDataSourcesForPeriodClosingCheck(DataSources);
	// _Demo Example End
...
Procedure BeforeCheckPeriodClosing(Object,
	...
	// _Demo Example Start
	_DemoStandardSubsystems.BeforeCheckPeriodClosing(
