...
Procedure SetupFormBeforeClose(Cancel, Form, Exit) Export
	...
	QueryText = NStr("ru = 'Данные были изменены. Закрыть форму без сохранения изменений?';
						|en = 'Close the form without saving the changes?';");
...
Procedure DeleteSynchronizationSetting(Val InfobaseNode) Export
	...
	If DataExchangeServerCall.IsMasterNode(InfobaseNode) Then
		WarningText = NStr("ru = 'Отключение информационной базы от главного узла можно выполнить
			...
			|en = 'To detach the infobase from the main node,
...
Procedure BeforeWrite(Form, Cancel, WriteParameters) Export
	...
	If CheckResult.ThereIsAnActiveBackgroundTask Then 
		...
		WarningText = NStr("ru = 'Уже выполняется отложенная операция записи узла.
										|Повторите попытку позже';
										|en = 'Deferred node saving operation is already in progress.
										|Try again later';");
...
Procedure SelectAndSaveFileAtClient(Val FileToReceive, Val DialogParameters = Undefined) Export
	...
	DefaultDialogOptions.Insert("Title",               NStr("ru = 'Выберите файл для сохранения';
...
Function DataImportHyperlinksHeaders() Export
	...
	Structure = New Structure;
	Structure.Insert("Undefined",               NStr("ru = 'Получение данных не выполнялось';
															|en = 'Data was not received';"));
	Structure.Insert("Error",                     NStr("ru = 'Не удалось получить данные';
															|en = 'Could not receive data';"));
	Structure.Insert("CompletedWithWarnings", NStr("ru = 'Данные получены с предупреждениями';
															|en = 'Data was received with warnings';"));
	Structure.Insert("Success",                      NStr("ru = 'Данные успешно получены';
															|en = 'Data was received';"));
	Structure.Insert("Perform",                 NStr("ru = 'Выполняется получение данных...';
															|en = 'Receiving data…';"));
	
	Structure.Insert("Warning_ExchangeMessageAlreadyAccepted", NStr("ru = 'Нет новых данных для получения';
																				|en = 'No new data to receive';"));
	Structure.Insert("ErrorMessageTransport",                      NStr("ru = 'Не удалось получить данные';
																				|en = 'Could not receive data';"));
...
Function DataExportHyperlinksHeaders() Export
	...
	Structure = New Structure;
	Structure.Insert("Undefined", NStr("ru = 'Отправка данных не выполнялась';
											|en = 'Data was not sent';"));
	Structure.Insert("Error",       NStr("ru = 'Не удалось отправить данные';
											|en = 'Could not send data';"));
	Structure.Insert("Success",        NStr("ru = 'Данные успешно отправлены';
											|en = 'Data was sent';"));
	Structure.Insert("Perform",   NStr("ru = 'Выполняется отправка данных...';
											|en = 'Sending data…';"));
	
	Structure.Insert("Warning_ExchangeMessageAlreadyAccepted", NStr("ru = 'Данные отправлены с предупреждениями';
																				|en = 'Data was sent with warnings';"));
	Structure.Insert("CompletedWithWarnings",                     NStr("ru = 'Данные отправлены с предупреждениями';
																				|en = 'Data was sent with warnings';"));
	Structure.Insert("ErrorMessageTransport",                      NStr("ru = 'Не удалось отправить данные';
																				|en = 'Could not send data';"));
...
Procedure FileDirectoryChoiceHandler(Object, Val PropertyName, StandardProcessing = False, Val DialogParameters = Undefined, CompletionNotification = Undefined) Export
	...
	DefaultDialogOptions = New Structure;
	DefaultDialogOptions.Insert("Title", NStr("ru = 'Укажите каталог';
												|en = 'Select directory';") );
...
Procedure FileSelectionHandler(Object, Val PropertyName, StandardProcessing = False, Val DialogParameters = Undefined, CompletionNotification = Undefined) Export
	...
	DefaultDialogOptions.Insert("Title",                   NStr("ru = 'Выберите файл';
																	|en = 'Select file';"));
	DefaultDialogOptions.Insert("MultipleChoice",          False);
	DefaultDialogOptions.Insert("Preview",     False);
...
Function DataExchangeEventLogEvent() Export
	...
	Return NStr("ru = 'Обмен данными';
				|en = 'Data exchange';", CommonClient.DefaultLanguageCode());
...
Procedure OpenInstructionHowToChangeDataSynchronizationPassword(Val AccountPasswordRecoveryAddress) Export
	...
	If IsBlankString(AccountPasswordRecoveryAddress) Then
		...
		ShowMessageBox(, NStr("ru = 'Адрес инструкции для восстановления пароля учетной записи не задан.';
										|en = 'The address of the password recovery instruction is not specified.';"));
...
Function OpenExportAdditionFormAllDocuments(Val ExportAddition, Val Owner=Undefined, Val Uniqueness=Undefined, Val Window=Undefined) Export
	...
	FormParameters.Insert("Title", NStr("ru = 'Добавление документов для отправки';
												|en = 'Add documents to send';") );
