...
Procedure OnDefineChecks(ChecksGroups, Checks) Export
	// _Demo Example Start
	_DemoStandardSubsystems.OnDefineChecks(ChecksGroups, Checks);
	// _Demo Example End
EndProcedure
...
Procedure OnDetermineIndicationGroupParameters(IndicationGroupParameters, Val ObjectWithIssueType) Export
	// _Demo Example Start
	_DemoStandardSubsystems.OnDetermineIndicationGroupParameters(IndicationGroupParameters, ObjectWithIssueType);
	// _Demo Example End
EndProcedure
...
Procedure OnDetermineIndicatiomColumnParameters(IndicationColumnParameters, FullName) Export
	// _Demo Example Start
	_DemoStandardSubsystems.OnDetermineIndicatiomColumnParameters(IndicationColumnParameters, FullName);
	// _Demo Example End
EndProcedure
...
Procedure BeforeWriteIssue(Issue1, ObjectReference, Attributes) Export
	// _Demo Example Start
	_DemoStandardSubsystems.BeforeWriteIssue(Issue1, ObjectReference, Attributes);
	// _Demo Example End
EndProcedure
