...
Function ClosingDatesDetails() Export
	...
	List = New Map;
	List.Insert("",                      NStr("ru = 'Не установлена';
													|en = 'No date';"));
	List.Insert("Custom",      NStr("ru = 'Произвольная дата';
													|en = 'Custom date';"));
	List.Insert("EndOfLastYear",     NStr("ru = 'Конец прошлого года';
													|en = 'End of last year';"));
	List.Insert("EndOfLastQuarter", NStr("ru = 'Конец прошлого квартала';
													|en = 'End of last quarter';"));
	List.Insert("EndOfLastMonth",   NStr("ru = 'Конец прошлого месяца';
													|en = 'End of last month';"));
	List.Insert("EndOfLastWeek",    NStr("ru = 'Конец прошлой недели';
													|en = 'End of last week';"));
	List.Insert("PreviousDay",        NStr("ru = 'Предыдущий день';
													|en = 'Previous day';"));
