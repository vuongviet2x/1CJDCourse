...
Procedure OnStart(Parameters) Export
	...
	If Settings.RestorePerformed Then
		NotificationText1 = NStr("ru = 'Восстановление данных проведено успешно.';
								|en = 'Data successfully restored.';");
		ShowUserNotification(NStr("ru = 'Данные восстановлены.';
											|en = 'Data is restored.';"), , NotificationText1);
	EndIf;
...
#EndIf
	...
	WarningParameters.CheckBoxText = NStr("ru = 'Выполнить резервное копирование';
												|en = 'Back up';");
	WarningParameters.Priority = 50;
	WarningParameters.WarningText = NStr("ru = 'Запланировано резервное копирование при завершении работы.';
														|en = 'Backup scheduled at exit.';");
...
Procedure PerformABackup()
	...
	Buttons.Add("Yes", NStr("ru = 'Да';
								|en = 'Yes';"));
	Buttons.Add("None", NStr("ru = 'Нет';
								|en = 'No';"));
	Buttons.Add("Snooze", NStr("ru = 'Отложить на 15 минут';
									|en = 'Snooze for 15 minutes';"));
	
	DescriptionOfTheAlert = New NotifyDescription("PerformABackupCompletion", ThisObject);
	ShowQueryBox(DescriptionOfTheAlert, NStr("ru = 'Все готово для выполнения резервного копирования по расписанию.
		|Выполнить резервное копирование сейчас?';
		|en = 'Scheduled backup is all set to start.
		|Do you want to start it now?';"),
		Buttons, 30, "Yes", NStr("ru = 'Резервное копирование по расписанию';
								|en = 'Scheduled backup';"), "Yes");
...
Procedure CheckIBBackup(Parameters)
	...
	Else
		...
		ShowUserNotification(NStr("ru = 'Резервное копирование';
			...
			NStr("ru = 'Резервное копирование проведено успешно';
				|en = 'Backup successful';"), PictureLib.DialogInformation);
...
Procedure NotifyUserOfBackup(NotificationOption)
	...
	If NotificationOption = "Overdue" Then
		...
		ExplanationText = NStr("ru = 'Автоматическое резервное копирование не было выполнено.';
								|en = 'Automatic backup has not been done.';"); 
		ShowUserNotification(NStr("ru = 'Резервное копирование';
											|en = 'Backup';"),
	...
	ElsIf NotificationOption = "NotConfiguredYet" Then
		...
		ExplanationText = NStr("ru = 'Рекомендуется настроить резервное копирование информационной базы.';
								|en = 'It is recommended that you set up infobase backup.';"); 
		ShowUserNotification(NStr("ru = 'Резервное копирование';
											|en = 'Backup';"),
...
Function EventLogEvent() Export
	...
	Return NStr("ru = 'Резервное копирование информационной базы';
				|en = 'Infobase backup';", CommonClient.DefaultLanguageCode());
		...
		For Each DeletedFile In DeletedFileList Do
			...
			Except
				EventLogClient.AddMessageForEventLog(EventLogEvent(), "Error",
					NStr("ru = 'Не удалось провести очистку каталога с резервными копиями.';
						|en = 'Failed to clean up backup storage directory.';") + Chars.LF 
...
Function ClientBackupParameters() Export
	...
	ParametersStructure.Insert("EventLogEvent", NStr("ru = 'Резервное копирование ИБ';
																	|en = 'Infobase backup';"));
