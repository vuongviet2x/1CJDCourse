...
Procedure ShowAllVisibleAttributesUnlockedWarning(ContinuationHandler = Undefined) Export
	...
	ShowMessageBox(ContinuationHandler,
		NStr("ru = 'Редактирование всех видимых реквизитов объекта уже разрешено.';
			|en = 'Editing visible attributes of the object is already allowed.';"));
...
Procedure CheckObjectRefs(Val ContinuationHandler, Val ReferencesArrray, Val AttributesSynonyms) Export
	...
	DialogTitle = NStr("ru = 'Разрешение редактирования реквизитов';
							|en = 'Allow attribute edit';");
		...
		QueryText = StringFunctionsClientServer.SubstituteParametersToString(
			NStr("ru = 'Для того чтобы не допустить рассогласования данных в приложении,
			           ...
			           |Поиск мест использования может занять длительное время.';
						|en = 'To prevent data inconsistency, the following attributes have been locked:
						|%1.
						|
	...
	Buttons.Add(DialogReturnCode.Yes, NStr("ru = 'Проверить и разрешить';
												|en = 'View and allow';"));
