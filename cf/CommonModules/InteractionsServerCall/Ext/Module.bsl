...
Function SendReceiveUserEmailInBackground(UUID) Export
	...
	If Interactions.BackgroundJobReceivingSendingMailInProgress() Then
		Common.MessageToUser(NStr("ru = 'Отправка и получение почты уже выполняется. Пожалуйста, подождите...';
													|en = 'Mail synchronization in progress. Please wait…';"));
		Return Undefined;
	EndIf;
	...
	ExecutionParameters.BackgroundJobDescription = NStr("ru = 'Получение и отправка электронной почты пользователя';
															|en = 'Mail Sync';");
