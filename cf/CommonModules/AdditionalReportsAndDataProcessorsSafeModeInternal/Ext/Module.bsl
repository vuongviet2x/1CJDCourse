...
Function ExternalModuleContainerDictionary() Export
	...
	Result.Insert("Nominative", NStr("ru = 'Дополнительный отчет или обработка';
											|en = 'Additional report or data processor';"));
	Result.Insert("Genitive", NStr("ru = 'Дополнительного отчета или обработки';
											|en = 'Additional report or data processor';"));
