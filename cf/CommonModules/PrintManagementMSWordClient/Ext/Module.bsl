...
Function EventLogEvent()
	Return NStr("ru = 'Печать';
				|en = 'Print';", CommonClient.DefaultLanguageCode());
EndFunction
...
#Else		
	ClarificationText = NStr("ru = 'Для вывода печатных форм в формате Microsoft Word требуется, чтобы на компьютере был установлен пакет Microsoft Office.';
							|en = 'To output print forms in MS Word formats, Microsoft Office must be installed.';");
#EndIf
