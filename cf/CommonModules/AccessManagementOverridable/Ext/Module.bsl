...
Procedure OnFillListsWithAccessRestriction(Lists) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnFillListsWithAccessRestriction(Lists);
	// _Demo Example End
...
Procedure OnFillSuppliedAccessGroupProfiles(ProfilesDetails, ParametersOfUpdate) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnFillSuppliedAccessGroupProfiles(ProfilesDetails, ParametersOfUpdate);
	// _Demo Example End
...
Procedure OnFillAccessRightsDependencies(RightsDependencies) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnFillAccessRightsDependencies(RightsDependencies);
	// _Demo Example End
...
Procedure OnFillAccessKindUsage(AccessKind, Use) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnFillAccessKindUsage(AccessKind, Use);
	// _Demo Example End
...
Procedure OnFillAccessRestriction(List, Restriction) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnFillAccessRestriction(List, Restriction);
	// _Demo Example End
...
Procedure OnFillMetadataObjectsAccessRestrictionKinds(LongDesc) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnFillMetadataObjectsAccessRestrictionKinds(LongDesc);
	// _Demo Example End
...
Procedure OnChangeAccessValuesSets(Ref, RefsToDependentObjects) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnChangeAccessValuesSets(Ref, RefsToDependentObjects);
	// _Demo Example End
