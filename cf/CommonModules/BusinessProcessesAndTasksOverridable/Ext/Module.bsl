...
Procedure OnDetermineBusinessProcesses(AttachedBusinessProcesses) Export
	...
	// _Demo Example Start
	AttachedBusinessProcesses.Insert(Metadata.BusinessProcesses._DemoJobWithRoleAddressing.FullName(), "");
	// _Demo Example End
...
Procedure OnFillingAccessValuesSets(Object, Table) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnFillBusinessProcessesAccessValuesSets(Object, Table)
	// _Demo Example End
...
Procedure OnInitiallyFillPerformersRoles(LanguagesCodes, Items, TabularSections) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnInitiallyFillPerformersRoles(LanguagesCodes, Items, TabularSections)
	// _Demo Example End
...
Procedure AtInitialPerformerRoleFilling(Object, Data, AdditionalParameters) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.AtInitialPerformerRoleFilling(Object, Data, AdditionalParameters);
	// _Demo Example End
...
Procedure OnInitialFillingTasksAddressingObjects(LanguagesCodes, Items, TabularSections) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnInitialFillingTasksAddressingObjects(LanguagesCodes, Items, TabularSections);
	// _Demo Example End
...
Procedure OnInitialFillingTaskAddressingObjectItem(Object, Data, AdditionalParameters) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnInitialFillingTaskAddressingObjectItem(Object, Data, AdditionalParameters);
	// _Demo Example End
