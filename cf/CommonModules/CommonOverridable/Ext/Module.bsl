...
Procedure OnDetermineCommonCoreParameters(CommonParameters) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnDetermineCommonCoreParameters(CommonParameters);
	// _Demo Example End
...
Procedure OnAddSessionParameterSettingHandlers(Handlers) Export
	...
	// _Demo Example Start
	Handlers.Insert(Metadata.SessionParameters._DemoCurrentProject.Name, 
		"Catalogs._DemoProjects.SessionParametersSetting"); 
	// _Demo Example End
...
Procedure OnAddClientParametersOnStart(Parameters) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnAddClientParametersOnStart(Parameters);
	// _Demo Example End
...
Procedure OnAddReferenceSearchExceptions(RefSearchExclusions) Export
	...
	// _Demo Example Start
	RefSearchExclusions.Add(Metadata.AccumulationRegisters._DemoGoodsBalancesInStorageLocations.Dimensions.Products);
	RefSearchExclusions.Add("ChartOfCalculationTypes._DemoBaseEarnings.StandardTabularSection.BaseCalculationTypes.StandardAttribute.CalculationType");
	RefSearchExclusions.Add(Metadata.InformationRegisters._DemoWarehouseDocumentsRegister);
	RefSearchExclusions.Add(Metadata.InformationRegisters._DemoCompaniesEmployees.Dimensions.Individual);
	RefSearchExclusions.Add(Metadata.Documents._DemoForwarderInstruction);
	// _Demo Example End
...
Procedure OnDefineSubordinateObjects(SubordinateObjects) Export
	...
	// _Demo Example Start
	SubordinateObject = SubordinateObjects.Add();
	SubordinateObject.SubordinateObject = Metadata.Catalogs._DemoProductDimensionKeys;
	SubordinateObject.LinksFields = Catalogs._DemoProductDimensionKeys.KeyAttributes();
	SubordinateObject.OnSearchForReferenceReplacement = "Catalogs._DemoProductDimensionKeys";
	SubordinateObject.RunReferenceReplacementsAutoSearch = True;
	
	SubordinateObject = SubordinateObjects.Add();
	SubordinateObject.SubordinateObject = Metadata.Catalogs._DemoBankAccounts;
	SubordinateObject.LinksFields = "Owner, AccountNumber, BankBIC";
	SubordinateObject.OnSearchForReferenceReplacement = "Catalogs._DemoBankAccounts";
	// _Demo Example End
...
Procedure AfterReplaceRefs(Result, ExecutionParameters, SearchTable) Export
	...
	// The _DemoCompaniesEmployees information register was included in the search exceptions. Run the replacement for the register.
	Filter = New Structure("Metadata", Metadata.InformationRegisters._DemoCompaniesEmployees);
	If SearchTable.FindRows(Filter).Count() > 0 Then
		InformationRegisters._DemoCompaniesEmployees.ReplaceReferences(Result, ExecutionParameters, SearchTable);
	EndIf;	
	// _Demo Example End
...
Procedure OnAddMetadataObjectsRenaming(Total) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnAddMetadataObjectsRenaming(Total);
	// _Demo Example End
...
Procedure OnDetermineDisabledSubsystems(DisabledSubsystems) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnDetermineDisabledSubsystems(DisabledSubsystems);
	// _Demo Example End
