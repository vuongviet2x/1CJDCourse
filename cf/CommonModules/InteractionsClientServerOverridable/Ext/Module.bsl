...
Procedure OnDeterminePossibleSubjects(SubjectsTypes) Export
	...
	// _Demo Example Start
	SubjectsTypes.Add("DocumentRef._DemoSalesOrder");
	// _Demo Example End
...
Procedure OnDeterminePossibleContacts(ContactsTypes) Export
	...
	Contact.Type = Type("CatalogRef._DemoPartners");
	Contact.Name = "_DemoPartners";
	Contact.Presentation = NStr("ru = 'Демо: Партнеры';
								|en = 'Demo: Partners';");
	Contact.Hierarchical = True;
	ContactsTypes.Add(Contact);
	
	Contact = InteractionsClientServer.NewContactDescription();
	Contact.Type = Type("CatalogRef._DemoPartnersContactPersons");
	Contact.Name = "_DemoPartnersContactPersons";
	Contact.Presentation = NStr("ru = 'Демо: Контактные лица партнеров';
								|en = 'Demo: Partner contacts';");
	Contact.HasOwner = True;
	Contact.OwnerName = "_DemoPartners";
	ContactsTypes.Add(Contact);
	
	Contact = InteractionsClientServer.NewContactDescription();
	Contact.Type = Type("CatalogRef._DemoCounterparties");
	Contact.Name = "_DemoCounterparties";
	Contact.Presentation = NStr("ru = 'Демо: Контрагенты';
								|en = 'Demo: Counterparties';");
	ContactsTypes.Add(Contact);
	// _Demo Example End
