...
Procedure AddFilterCondition(Filter, Val Property, Val ValueComparisonType, Val Value) Export
	...
	Else
		...
		Raise NStr("ru = 'Неверный тип параметра Фильтр, ожидалось <Структура> или <Массив>';
								|en = 'Unexpected type of the Filter parameter. Expected type is <Structure> or <Array>.';");
	...
	For Each Condition In Filter Do
		...
		Else
			...
			Raise StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Неверный тип значения параметра %1, ожидалось %2 или %3.';
					|en = 'Invalid value type of parameter %1, expected %2 or %3.';"),
...
Function AdministrationManager(Val AdministrationParameters)
	...
	Else
		...
		Raise StringFunctionsClientServer.SubstituteParametersToString(
			NStr("ru = 'Неизвестный тип параметра %1 (%2), ожидалось ""%3"" или ""%4"".';
				|en = 'Unknown type of parameter %1: %2. Expected values: ""%3"" or ""%4"".';"),
