...
// Returns a message type {http://www.1c.ru/SaaS/ControlZonesBackup/a.b.c.d}ZoneBackupSuccessfull.
// @skip-warning EmptyMethod - Implementation feature.
//
// Parameters:
...
//
// Returns:
//  XDTODataObject - message type.
//
Function AreaBackupMessageIsCreated(Val PackageToUse = Undefined) Export
EndFunction

// Returns a message type {http://www.1c.ru/SaaS/ControlZonesBackup/a.b.c.d}ZoneBackupFailed.
// @skip-warning EmptyMethod - Implementation feature.
//
// Parameters:
//  PackageToUse - String - a namespace of the message interface version, for which the message type is being received.
...
//  XDTODataObject - message type.
//
Function AreaArchivingErrorMessage(Val PackageToUse = Undefined) Export
EndFunction

// Returns a message type {http://www.1c.ru/SaaS/ControlZonesBackup/a.b.c.d}ZoneBackupSkipped.
// @skip-warning EmptyMethod - Implementation feature.
//
// Parameters:
//  PackageToUse - String - a namespace of the message interface version, for which the message type is being received.
...
//  XDTODataObject - message type.
//
Function AreaArchivingMessageWasSkipped(Val PackageToUse = Undefined) Export
EndFunction
