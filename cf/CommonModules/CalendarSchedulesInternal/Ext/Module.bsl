...
Procedure DistributeBusinessCalendarsDataToDependentData(Val UpdateConditions, 
	...
	For Each DataArea In AreasForUpdate Do
		...
		Except
			RollbackTransaction();
			WriteLogEvent(NStr("ru = 'Календарные графики.Распространение производственных календарей';
											|en = 'Calendar schedules.Distribute business calendars';", Common.DefaultLanguageCode()),
									EventLogLevel.Error,,,
