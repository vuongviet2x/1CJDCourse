...
Procedure OnCreateFormCertificateCheck(Certificate, AdditionalChecks, AdditionalChecksParameters, StandardChecks, EnterPassword = True) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnCreateFormCertificateCheck(Certificate,
		AdditionalChecks, AdditionalChecksParameters, StandardChecks, EnterPassword);
	// _Demo Example End
...
Procedure OnAdditionalCertificateCheck(Parameters) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnAdditionalCertificateCheck(Parameters);
	// _Demo Example End
