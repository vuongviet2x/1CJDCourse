...
Procedure OnSearchForContacts(Val ContactsTableName, QueryTextForSearch) Export
	...
	// _Demo Example Start
	If ContactsTableName = Metadata.Documents._DemoSalesOrder.FullName() Then
		QueryTextForSearch = Documents._DemoSalesOrder.TheTextOfTheRequestForContacts(True);
	EndIf;
	// _Demo Example End
...
Procedure OnFillingAccessValuesSets(Object, Table) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnFillAccessValuesSetsForInteractionObject(Object, Table)
	// _Demo Example End
