...
Procedure AfterCompleteRequestForPermissionsToUseExternalResources(Result, State) Export
	...
	If Result = DialogReturnCode.OK Then
		...
		ShowUserNotification(NStr("ru = 'Настройка разрешений';
											|en = 'Permission settings';"),,
			NStr("ru = 'Внесены изменения в настройки профилей безопасности в кластере серверов.';
				|en = 'Security profile settings are changed in the server cluster.';"));
