...
Procedure OnDefineObjectsWithCreationBasedOnCommands(Objects) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnDefineObjectsWithCreationBasedOnCommands(Objects);
	// _Demo Example End
...
Procedure OnAddGenerationCommands(Object, GenerationCommands, Parameters, StandardProcessing) Export
	...
	// _Demo Example Start
	_DemoStandardSubsystems.OnAddGenerationCommands(Object, GenerationCommands, Parameters, StandardProcessing);
	// _Demo Example End
