...
Procedure OnDetermineCompanyPrefix(Val Organization, CompanyPrefix) Export
	...
	// _Demo Example Start
	FunctionalOptionName = "_DemoCompanyPrefixes";
	FunctionalOptionParameterName = "_DemoCompany";
	// _Demo Example End
...
Function CompanyAttributeAvailable(Object)
	...
	If   (Common.IsCatalog(ObjectMetadata)
		...
		If CompanyAttribute1 = Undefined Then
			...
			MessageString = NStr("ru = 'Для объекта метаданных %1 не определен реквизит с именем %2.';
