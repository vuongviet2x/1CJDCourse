	...
	Else
		For Each Code In Codes Do
			...
			If CurrencyRef.IsEmpty() Then
				...
				CurrencyObject.DescriptionFull = NStr("ru = 'Валюта';
														|en = 'Currency';");
...
Procedure OnFillToDoList(ToDoList) Export
	...
	For Each Section In Sections Do
		...
		ToDoItem.Presentation  = NStr("ru = 'Курсы валют устарели';
...
Function SchemaDataPrintAmountWords()
	...
	If Common.SubsystemExists("StandardSubsystems.Print") Then
		...
		Field = FieldList.Add();
		Field.Id = "Currency";
		Field.Presentation = NStr("ru = 'Валюта';
									|en = 'Currency';");
		Field.ValueType = New TypeDescription();	
	
		Field = FieldList.Add();
		Field.Id = "NumberInWords";
		Field.Presentation = NStr("ru = 'Число прописью';
									|en = 'Amount in words';");
