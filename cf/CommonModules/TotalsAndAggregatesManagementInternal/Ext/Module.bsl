...
Procedure OnAddUpdateHandlers(Handlers) Export
	...
	Handler.Comment         = NStr("ru = 'Включает или отключает обновление и перестроение агрегатов по расписанию.';
											|en = 'Toggles the update and rebuild schedule for aggregates.';");
...
Procedure OnFillToDoList(ToDoList) Export
	...
	Prototype.Presentation = NStr("ru = 'Оптимизировать работу приложения';
