...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not Users.IsFullUser(, Not DataSeparationEnabled) Then
		Raise(NStr("ru = 'Недостаточно прав для открытия списка пользователей информационной базы.';
								|en = 'Insufficient rights to access the infobase user list.';"),
...
Procedure CancelMapping(Command)
	...
	Buttons.Add("CancelMapping", NStr("ru = 'Отменить сопоставление';
													|en = 'Clear mapping';"));
	Buttons.Add("KeepMapping", NStr("ru = 'Оставить сопоставление';
													|en = 'Keep mapping';"));
...
Procedure SetConditionalAppearance()
	...
	Item.Appearance.SetParameterValue("Text", NStr("ru = '<Нет данных>';
																|en = '<No data>';"));
	Item.Appearance.SetParameterValue("Format", NStr("ru = 'БЛ=Нет; БИ=Да';
																	|en = 'BF=No; BT=Yes';"));
	...
	Item.Appearance.SetParameterValue("Format", NStr("ru = 'БЛ=; БИ=Да';
																	|en = 'BF=; BT=Yes';"));
...
Procedure DeleteCurrentIBUser(DeleteRow = False)
	...
	ShowQueryBox(
		...
		NStr("ru = 'Удалить пользователя информационной базы?';
			|en = 'Do you want to delete the infobase user?';"),
