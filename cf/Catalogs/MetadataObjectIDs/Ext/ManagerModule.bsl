...
Procedure CheckForUsage(ExtensionsObjects = False) Export
	...
	If StandardSubsystemsCached.DisableMetadataObjectsIDs() Then
		ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
			NStr("ru = 'Справочник ""%1"" не используется.';
				|en = 'The ""%1"" catalog is not used.';"), CatalogDescription(ExtensionsObjects));
		Raise ErrorText;
	EndIf;
		...
		ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
			NStr("ru = 'Справочник ""%1"" не может использоваться
					   ...
					   |или программно очистите константу Главный узел.';
						|en = 'Cannot use catalog ""%1"" in an infobase whose
		...
		For Each Object In Objects Do
			...
			Else
				...
				If Not ValueIsFilled(ItemToImportProperties.Ref) Then
					ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
						NStr("ru = 'Невозможно загрузить идентификаторы объектов метаданных из главного узла.
						           |Для нового элемента не указана ссылка нового:
						           |""%1"".';
									|en = 'Could not import the metadata object ids from the master node.
...
Function MetadataObjectID(MetadataObjectDetails, RaiseException1) Export
	...
	If MetadataObjectDetailsType = Type("Type") Then
		...
		Else
			ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Некорректное значение параметра %1 в функции %2.
				           |Указан несуществующий объект метаданных: ""%3"".';
							|en = 'Incorrect value of the %1 parameter in the %2 function.
	...
	Else
		ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
			NStr("ru = 'Некорректный тип параметра %1 в функции %2:
			           |""%3"".';
						|en = 'Incorrect type of the %1 parameter in the %2 function:
						|""%3"".';"),
			"MetadataObjectDetails",
			"Common.MetadataObjectID",
...
Function MetadataObjectIDs(MetadataObjectsDetails, RaiseException1 = True, OneItem = False) Export
	...
	For Each MetadataObjectDetails In MetadataObjectsDetails Do
		...
		If MetadataObjectDetailsType = Type("Type") Then
			...
			Else
				ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
					NStr("ru = 'Некорректное значение параметра %1 функции %2:
					           |Указан несуществующий объект метаданных: ""%3"".';
								|en = 'Incorrect value of parameter %1 in function %2.
								|Non-existing metadata object is specified: ""%3"".';"),
		...
		Else
			ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Некорректный тип параметра %1 функции %2:
				           |""%3"".';
							|en = 'Incorrect type of parameter %1 in function %2:
							|""%3"".';"),
				"MetadataObjectsDetails",
				"Common.MetadataObjectIDs",
				MetadataObjectDetailsType);
...
Function MetadataObjectCollectionProperties(ExtensionsObjects = False) Export
	...
	String.Synonym         = NStr("ru = 'Константы';
									|en = 'Constants';");
	String.SingularName     = "Constant";
	String.SingularSynonym = NStr("ru = 'Константа';
									|en = 'Constant';");
	...
	String.Synonym         = NStr("ru = 'Подсистемы';
									|en = 'Subsystems';");
	String.SingularName     = "Subsystem";
	String.SingularSynonym = NStr("ru = 'Подсистема';
									|en = 'Subsystem';");
	String.NoData       = True;
	...
	String.Name             = "Roles";
	String.Synonym         = NStr("ru = 'Роли';
									|en = 'Roles';");
	String.SingularName     = "Role";
	String.SingularSynonym = NStr("ru = 'Роль';
									|en = 'Role';");
	String.NoData       = True;
	...
	String.Synonym         = NStr("ru = 'Планы обмена';
									|en = 'Exchange plans';");
	String.SingularName     = "ExchangePlan";
	String.SingularSynonym = NStr("ru = 'План обмена';
									|en = 'Exchange plan';");
	String.ExtensionsObjects = True;
	...
	String.Synonym         = NStr("ru = 'Справочники';
									|en = 'Catalogs';");
	String.SingularName     = "Catalog";
	String.SingularSynonym = NStr("ru = 'Справочник';
									|en = 'Catalog';");
	String.ExtensionsObjects = True;
	...
	String.Synonym         = NStr("ru = 'Документы';
									|en = 'Documents';");
	String.SingularName     = "Document";
	String.SingularSynonym = NStr("ru = 'Документ';
									|en = 'Document';");
	String.ExtensionsObjects = True;
	...
	String.Synonym         = NStr("ru = 'Журналы документов';
									|en = 'Document journals';");
	String.SingularName     = "DocumentJournal";
	String.SingularSynonym = NStr("ru = 'Журнал документов';
									|en = 'Document journal';");
	String.NoData       = True;
	String.ExtensionsObjects = True;
	...
	String.Name             = "Reports";
	String.Synonym         = NStr("ru = 'Отчеты';
									|en = 'Reports';");
	String.SingularName     = "Report";
	String.SingularSynonym = NStr("ru = 'Отчет';
									|en = 'Report';");
	String.NoData       = True;
	String.ExtensionsObjects = True;
	...
	String.Synonym         = NStr("ru = 'Обработки';
									|en = 'Data processors';");
	String.SingularName     = "DataProcessor";
	String.SingularSynonym = NStr("ru = 'Обработка';
									|en = 'Data processor';");
	String.NoData       = True;
	String.ExtensionsObjects = True;
	...
	String.Synonym         = NStr("ru = 'Планы видов характеристик';
									|en = 'Charts of characteristic types';");
	String.SingularName     = "ChartOfCharacteristicTypes";
	String.SingularSynonym = NStr("ru = 'План видов характеристик';
	...
	String.Synonym         = NStr("ru = 'Планы счетов';
									|en = 'Charts of accounts';");
	String.SingularName     = "ChartOfAccounts";
	String.SingularSynonym = NStr("ru = 'План счетов';
	...
	String.Synonym         = NStr("ru = 'Планы видов расчета';
									|en = 'Charts of calculation types';");
	String.SingularName     = "ChartOfCalculationTypes";
	String.SingularSynonym = NStr("ru = 'План видов расчета';
	...
	String.Synonym         = NStr("ru = 'Регистры сведений';
									|en = 'Information registers';");
	String.SingularName     = "InformationRegister";
	String.SingularSynonym = NStr("ru = 'Регистр сведений';
	...
	String.Synonym         = NStr("ru = 'Регистры накопления';
									|en = 'Accumulation registers';");
	String.SingularName     = "AccumulationRegister";
	String.SingularSynonym = NStr("ru = 'Регистр накопления';
	...
	String.Synonym         = NStr("ru = 'Регистры бухгалтерии';
									|en = 'Accounting registers';");
	String.SingularName     = "AccountingRegister";
	String.SingularSynonym = NStr("ru = 'Регистр бухгалтерии';
	...
	String.Synonym         = NStr("ru = 'Регистры расчета';
									|en = 'Calculation registers';");
	String.SingularName     = "CalculationRegister";
	String.SingularSynonym = NStr("ru = 'Регистр расчета';
	...
	String.Synonym         = NStr("ru = 'Бизнес-процессы';
									|en = 'Business processes';");
	String.SingularName     = "BusinessProcess";
	String.SingularSynonym = NStr("ru = 'Бизнес-процесс';
									|en = 'Business process';");
	String.ExtensionsObjects = True;
	...
	String.Name             = "Tasks";
	String.Synonym         = NStr("ru = 'Задачи';
									|en = 'Tasks';");
	String.SingularName     = "Task";
	String.SingularSynonym = NStr("ru = 'Задача';
									|en = 'Task';");
	String.ExtensionsObjects = True;
	...
	Try
		...
		If ValueIsFilled(MetadataObjectRenamingList) Then
			ListOfCriticalChanges = StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Переименование идентификаторов объектов метаданных %1 -> %2:';
					|en = 'Rename IDs of metadata objects %1->%2:';"),
				"PreviousFullName",
				"NewFullName");
		...
		If ValueIsFilled(NewMetadataObjectsList) Then
			ListOfCriticalChanges = ListOfCriticalChanges
				+ NStr("ru = 'Добавление новых идентификаторов объектов метаданных:';
						|en = 'Added metadata object IDs:';")
		...
		If Not IsCheckOnly Then
			...
			If ValueIsFilled(ListOfCriticalChanges) Then
				EventLog.AddMessageForEventLog(?(ExtensionsObjects,
						NStr("ru = 'Идентификаторы объектов расширений.Выполнены критичные изменения';
							|en = 'Extension object IDs.Critical changes applied';",
							Common.DefaultLanguageCode()),
						NStr("ru = 'Идентификаторы объектов метаданных.Выполнены критичные изменения';
							|en = 'Metadata object IDs.Critical changes applied';",
							Common.DefaultLanguageCode())),
...
Function ExportAllIDs(ExtensionsObjects = False)
	...
	For Each String In Upload0 Do
		If Not ValueIsFilled(String.Ref) Then
			ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Данные справочника %1 повреждены.
				           |В конфигураторе в меню ""Администрирование"" выполните ""Тестирование и исправление..."".';
							|en = 'The catalog ""%1"" contains corrupted data.
...
Function KeyRole(MetadataObjectRole, RaiseException1 = True)
	...
	ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
		NStr("ru = 'Не удалось получить ключ роли %1';
			|en = 'Cannot receive a key of role %1';"), MetadataObjectRole.Name);
...
Function CatalogDescription(ExtensionsObjects)
	...
	If ExtensionsObjects Then
		CatalogDescription = NStr("ru = 'Идентификаторы объектов расширений';
									|en = 'Extension object IDs';");
	Else
		CatalogDescription = NStr("ru = 'Идентификаторы объектов метаданных';
									|en = 'Metadata object IDs';");
	EndIf;
...
Procedure RaiseByError(ExtensionsObjects, ErrorText)
	...
	ErrorTitle = StringFunctionsClientServer.SubstituteParametersToString(
		NStr("ru = 'Ошибка при работе со справочником ""%1"".';
			|en = '""%1"" catalog error.';"),
		CatalogDescription(ExtensionsObjects));
...
Function MetadataObjectIDsWithoutRetryAttempt(FullMetadataObjectsNames,
		...
		If FoundRows.Count() = 0 Then
			...
			If MetadataObject = Undefined Then
				...
				ErrorDescription = StringFunctionsClientServer.SubstituteParametersToString(
					NStr("ru = 'Объект метаданных с именем ""%1"" не существует.';
						|en = 'The metadata object with the ""%1"" name does not exist.';"),
	...
	If ErrorsCount > 0 Then
		...
		If OneItem Then
			ErrorTitle = StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Ошибка при выполнении функции %1.';
					|en = 'Error executing function ""%1"".';"),
				"Common.MetadataObjectID");
		...
		Else
			ErrorTitle = StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Ошибки при выполнении функции %1.';
					|en = 'Errors when executing function %1.';"),
				"Common.MetadataObjectIDs");
		EndIf;
		...
		For Each ErrorDescription In Errors Do
			...
			If ErrorNumber = 3 And ErrorsCount > 5 Then
				...
				ErrorDescription = "... " + StringFunctionsClientServer.StringWithNumberForAnyLanguage(
					NStr("ru = ';И еще %1 ошибка;;И еще %1 ошибки;И еще %1 ошибок;И еще %1 ошибки';
						|en = ';and %1 more error;;;;and %1 more errors';"),
...
Function MetadataObjectsByIDsWithoutRetryAttempt(IDs,
	...
	For Each Properties In Upload0 Do
			...
			If CheckResult.MetadataObject = Undefined Then
				...
				If Properties.ExtensionObject Then
					...
					If InstalledExtensions.Count() = 0 Then
						...
						ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
							NStr("ru = 'Объект ""%2"" не существует, т.к. удалено расширение ""%1"".
							           |Связанные с ним данные и настройки более недоступны.';
										|en = 'The object ""%2"" does not exist since its extension ""%1"" was uninstalled.
										|The related data and settings are no longer available.';"),
							ExtensionName,
							IDPresentation);
					...
					ElsIf Not InstalledExtensions[0].Active Then
						ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
							NStr("ru = 'Расширение ""%1"" установлено, но выключено.
							           |Включите расширение и перезапустите сеанс.';
										|en = 'The extension ""%1"" is installed but disabled.
					...
					ElsIf DetachedExtensions.Count() > 0 And Not DetachedExtensions[0].Active
						...
						ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
							NStr("ru = 'Расширение ""%1"" установлено после запуска сеанса, поэтому не подключено.
							           |Перезапустите сеанс.';
										|en = 'The extension ""%1"" is installed but the app requires a restart.%1Restart the app.';"),
							ExtensionName);
						
					ElsIf DetachedExtensions.Count() > 0 And DetachedExtensions[0].Active Then
						ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
							NStr("ru = 'Расширение ""%1"" установлено, но отключено при запуске сеанса.
							           |Это значит, что при его подключении возникла непредвиденная ситуация.';
										|en = 'The extension ""%1"" is installed but it was disabled at the startup.
					...
					Else // ActiveExtensions.Count() > 0
						...
						If CheckResult.RemoteMetadataObject <> Undefined
						   ...
						   And CheckResult.RemoteMetadataObject.ConfigurationExtension().Name = ActiveExtensions[0].Name Then
							...
							ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
								NStr("ru = 'Идентификатор объекта метаданных ""%2"" расширения ""%1"" помечен на удаление.
								           |Обычно это значит, что расширение было удалено и установлено заново (вместо обновления расширения на новую версию).
								           |Связанные с ним данные и настройки более недоступны.';
											|en = 'The id of the ""%2"" metadata object, which is a part of the ""%1"" extension, is marked for deletion.
						...
						Else
							ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
								NStr("ru = 'Объект ""%2"" удален в текущей версии расширения ""%1"".
								           |Связанные с ним данные и настройки более недоступны.';
											|en = 'The object ""%2"" was deleted in the current version of the extension ""%1"".
											|The related data and settings are no longer available.';"),
								ExtensionName,
								IDPresentation);
						EndIf;
				...
				ElsIf CheckResult.RemoteMetadataObject <> Undefined
					...
					ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
						NStr("ru = 'Идентификатор объекта метаданных ""%1"" помечен на удаление.
						           |Это значит, что объект метаданных был удален из конфигурации, а позже снова добавлен.
						           |Связанные с ним данные и настройки более недоступны.';
									|en = 'The id of the ""%2"" metadata object is marked for deletion.
				...
				Else
					ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
						NStr("ru = 'Объект метаданных ""%1"" не существует, т.к. удален в этой версии приложении.
						           |Связанные с ним данные и настройки более недоступны.';
									|en = 'The object ""%1"" does not exist as it was removed from the current app version.
									|The related data and settings are no longer available.';"),
						IDPresentation);
					Raise ErrorText;
				EndIf;
		...
		If Not Properties.ExtensionObject And Properties.DeletionMark And Not DataBaseConfigurationChangedDynamically Then
			ErrorDescription = StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Идентификатор ""%1"" из справочника ""%2"" помечен на удаление.';
					|en = 'The id ""%1"" from the catalog ""%2"" is marked for deletion.';"),
				Properties.Presentation,
				CatalogDescription(Properties.ExtensionObject));
...
Function IDPresentation(Ref) Export
	...
	If FullName = Undefined Then
		Return NStr("ru = 'Объект не существует.';
...
// 3. It's executed when duplicates of metadata object IDs are found (a rare occurrence).
	...
	Try
		For Each TableRow In RefsTable Do
			...
			If RefToProcess <> TableRow.Data Then
				If RefToProcess <> Undefined And Parameters.Object <> Undefined Then
					...
					Except
						...
						ErrorInfo = ErrorInfo();
						ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
							NStr("ru = 'Не удалось записать объект ""%1"" по причине:
							           |%2';
										|en = 'Couldn''t write object ""%1"" due to:
										|%2';"),
				...
				For Each Movement In TableRow.Metadata.RegisterRecords Do
					...
					If MustWrite Then
						...
						Except
							...
							ErrorInfo = ErrorInfo();
							ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
								NStr("ru = 'Не удалось записать движения объекта ""%1"" в ""%2"" по причине:
								           |%3';
											|en = 'Couldn''t add to ""%2"" a record for object ""%1"" due to:
											|%3';"),
								GetURL(Parameters.Object.Ref),
						...
						If SingleRecordSet.Count() > 0 Then
							...
							If MustWrite Then
								...
								Except
									...
									ErrorInfo = ErrorInfo();
									ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
											NStr("ru = 'Не удалось записать данные по регистратору ""%1"" в ""%2"" по причине:
											           |%3';
														|en = 'Couldn''t add to ""%2"" data for recorder ""%1"" due to:
														|%3';"),
			...
			ElsIf Metadata.InformationRegisters.Contains(TableRow.Metadata) Then
				...
				Try
					...
					Except
						ErrorInfo = ErrorInfo();
						ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
							NStr("ru = 'Не удалена запись ""%1"" по причине:
							           |%2';
										|en = 'Record ""%1"" was not deleted due to:
										|%2';"),
					...
					Except
						ErrorInfo = ErrorInfo();
						ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
							NStr("ru = 'Не удалось добавить запись ""%1"" по причине:
							           |%2';
										|en = 'Record ""%1"" was not added due to:
										|%2';"),
							GetURL(RegisterManager.CreateRecordKey(DimensionStructure)),
							ErrorProcessing.DetailErrorDescription(ErrorInfo));
						Raise;
			...
			Else
				ErrorText = StringFunctionsClientServer.SubstituteParametersToString(
					NStr("ru = 'Значения не заменяются в данных типа: %1';
						|en = 'Cannot replace the values in data of the following type: %1.';"),
...
Procedure ReportError(Val LongDesc, ExtensionsObjects)
	...
	WriteLogEvent(
		?(ExtensionsObjects,
			NStr("ru = 'Идентификаторы объектов расширений.Замена идентификатора';
				|en = 'Extension object IDs.ID replacement';",
				Common.DefaultLanguageCode()),
			NStr("ru = 'Идентификаторы объектов метаданных.Замена идентификатора';
				|en = 'Metadata object IDs.ID replacement';",
				Common.DefaultLanguageCode())),
		EventLogLevel.Error,
		,
		,
