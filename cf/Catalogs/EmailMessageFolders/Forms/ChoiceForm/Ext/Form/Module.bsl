...
Procedure SetPredefinedFilters()
	...
	CommonClientServer.SetDynamicListFilterItem(List,
	                                                                        ...
	                                                                        NStr("ru = 'Отображение только не помеченных на удаление папок';
																				|en = 'Show only folders not marked for deletion';"),
	                                                                        True, 
...
Procedure OnChangeOwnerAtServer()
	...
	CommonClientServer.SetDynamicListFilterItem(List,
	                                                                        ...
	                                                                        Owner,
	                                                                        DataCompositionComparisonType.Equal,
	                                                                        NStr("ru = 'Отбор по владельцу папок';
																				|en = 'Filter by folder owner';"),
	                                                                        ValueIsFilled(Owner), 
	                                                                        DataCompositionSettingsItemViewMode.Inaccessible);
