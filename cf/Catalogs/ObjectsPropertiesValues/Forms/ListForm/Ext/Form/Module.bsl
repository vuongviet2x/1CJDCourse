	...
	If IsBlankString(TitleLine) Then
		...
		If ValueIsFilled(Property) Then
			If Not Parameters.ChoiceMode Then
				TitleLine = NStr("ru = 'Значения свойства %1';
										|en = '""%1"" property values';");
			ElsIf SelectGroups Then
				TitleLine = NStr("ru = 'Выберите группу значений свойства %1';
										|en = 'Select ""%1"" property values group';");
			Else
				TitleLine = NStr("ru = 'Выберите значение свойства %1';
										|en = 'Select ""%1"" property value';");
			EndIf;
		...
		ElsIf Parameters.ChoiceMode Then
			...
			If SelectGroups Then
				TitleLine = NStr("ru = 'Выберите группу значений свойства';
										|en = 'Select property value group';");
			Else
				TitleLine = NStr("ru = 'Выберите значение свойства';
										|en = 'Select property value';");
			EndIf;
		EndIf;
	EndIf;
