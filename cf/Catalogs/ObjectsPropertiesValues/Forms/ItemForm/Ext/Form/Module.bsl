...
Procedure AfterWrite(WriteParameters)
	...
	Notify("Write_ObjectsPropertiesValues",
...
Procedure SetHeader()
	...
	Else
		...
		If ValueIsFilled(Object.Ref) Then
			Title = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = '%1 (Значение свойства %2)';
																					|en = '%1 (""%2"" property value)';"),
				Object.Description,
				PropertyName);
		Else
			Title = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = 'Значение свойства %1 (Создание)';
																					|en = '""%1"" property value (Create)';"), PropertyName);
		EndIf;
	EndIf;
