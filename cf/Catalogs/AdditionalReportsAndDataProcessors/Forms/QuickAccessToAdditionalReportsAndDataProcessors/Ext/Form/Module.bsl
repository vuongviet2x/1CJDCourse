...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Title = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = 'Быстрый доступ к команде ""%1""';
																			|en = 'Quick access to ""%1"" command';"), Parameters.CommandPresentation);
