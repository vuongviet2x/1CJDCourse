...
Procedure PreviousPage(Command)
	...
	If Items.Pages.CurrentPage = Items.ResultTablePage Then
		...
		Items.NextPageButton.Title = NStr("ru = 'Далее';
												|en = 'Next';") + ">";
...
Procedure SetHelpTexts()
	...
	If CurrentPage = Items.ResultTablePage Then
		InformationHeader                 = NStr("ru = 'Результирующая таблица:';
												|en = 'Result table:';");
		InformationFooter                = NStr("ru = 'Нажмите Готово для окончания редактирования.';
												|en = 'Click Finish to finish editing.';");
		Items.NextPageButton.Title = NStr("ru = 'Готово';
												|en = 'Finish';");
	Else
		Items.NextPageButton.Title = NStr("ru = 'Далее>>';
												|en = 'Next>>';");
		If CurrentPage = Items.QuestionsPage Then
			If TabularQuestionType = PredefinedValue("Enum.TabularQuestionTypes.Composite") Then
				InformationHeader  = NStr("ru = 'Подбор вопросов. Укажите хотя бы один вопрос:';
										|en = 'Pick questions. Specify at least one question:';");
				InformationFooter = NStr("ru = 'Нажмите Далее для просмотра получившейся таблицы.';
										|en = 'Click Next to view the resulting table.';");
			ElsIf TabularQuestionType = PredefinedValue("Enum.TabularQuestionTypes.PredefinedAnswersInRowsAndColumns") Then
				InformationHeader  =NStr("ru = 'Подбор вопросов. Укажите три вопроса:';
										|en = 'Pick questions. Specify three questions:';");
				InformationFooter =NStr("ru = 'Нажмите Далее для подбора предопределенных ответов.';
										|en = 'Click Next to pick predefined responses.';");
			Else
				InformationHeader   =NStr("ru = 'Подбор вопросов. Укажите как минимум два вопроса:';
										|en = 'Pick questions. Specify at least two questions:';");
				InformationFooter  =NStr("ru = 'Нажмите Далее для подбора предопределенных ответов.';
										|en = 'Click Next to pick predefined responses.';");
			EndIf;
		ElsIf CurrentPage = Items.TableQuestionTypePage Then
			InformationHeader       = NStr("ru = 'Выбор типа табличного вопроса:';
										|en = 'Select a question chart type:';");
			InformationFooter      = NStr("ru = 'Нажмите Далее для подбора вопросов:';
										|en = 'Click Next to pick questions:';");
		Else
			InformationHeader  = NStr("ru = 'Подбор предопределенных ответов:';
									|en = 'Pick predefined responses:';");
			InformationFooter = NStr("ru = 'Нажмите Далее для просмотра получившейся таблицы:';
									|en = 'Click Next to view the resulting table:';");
		EndIf;
	EndIf;
