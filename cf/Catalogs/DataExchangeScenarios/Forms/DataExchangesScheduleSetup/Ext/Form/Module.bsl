...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Title = NStr("ru = 'Сценарии синхронизации данных для: [InfobaseNode]';
					|en = 'Synchronization scenario setup for: [InfobaseNode]';");
...
Procedure ExecuteScenario(Command)
	...
	If Cancel Then
		Message = NStr("ru = 'Сценарий синхронизации выполнен с ошибками.';
						|en = 'The synchronization scenario completed with errors.';");
		Picture = PictureLib.Error32;
	Else
		Message = NStr("ru = 'Сценарий синхронизации успешно выполнен.';
						|en = 'The synchronization scenario is completed.';");
		Picture = Undefined;
	EndIf;
