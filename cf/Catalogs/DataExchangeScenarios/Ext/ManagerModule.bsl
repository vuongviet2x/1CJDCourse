...
Procedure CreateScenario(
	...
	Description = NStr("ru = 'Автоматическая синхронизация данных с %1';
						|en = 'Synchronize data with %1 automatically';");
...
Procedure SetScheduledJobParameters(ScheduledJobObject, JobSchedule, CurrentObject)
	...
	ScheduledJobDescription = NStr("ru = 'Выполнение обмена по сценарию: %1';
											|en = 'Exchange data by scenario: %1';");
...
Procedure WriteScheduledJob(Cancel, ScheduledJobObject)
	...
	Except
		...
		MessageString = NStr("ru = 'Произошла ошибка при сохранении расписания выполнения обменов. Подробное описание ошибки: %1';
								|en = 'Couldn''t save the exchange schedule. Error details: %1';");
