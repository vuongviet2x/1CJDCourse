...
Procedure BeforeWrite(Cancel)
	...
	If Not AdditionalProperties.Property("PredefinedObjectsFilling") Then
		Raise NStr("ru = 'Справочник ""Предопределенные варианты отчетов"" изменяется только при автоматическом заполнении его данных.';
								|en = 'Predefined report options catalog is modified only during automatic population.';");
	EndIf;
EndProcedure
