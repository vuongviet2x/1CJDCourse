...
Procedure BeforeWrite(Cancel, WriteParameters)
	...
	For Each Condition In VisibilityConditions Do
		...
		If Not ValueIsFilled(Condition.ComparisonType) Then
			...
			MessageText = NStr("ru = 'Укажите вид сравнения';
									|en = 'Specify a comparison type';");
		...
		If Not ValueIsFilled(Condition.Field) Then
			MessageText = NStr("ru = 'Выберите поле';
									|en = 'Select a field';");
...
Function RepresentationsViewsComparisons()
	...
	Result = New Map();
	Result.Insert("Equal", NStr("ru = 'Равно';
									|en = 'Equal to';"));
	Result.Insert("NotEqual", NStr("ru = 'Не равно';
										|en = 'Not equal to';"));
	Result.Insert("Filled", NStr("ru = 'Заполнено';
										|en = 'Filled';"));
	Result.Insert("NotFilled", NStr("ru = 'Не заполнено';
											|en = 'Not filled';"));
	Result.Insert("InList", NStr("ru = 'В списке';
										|en = 'In list';"));
	Result.Insert("NotInList", NStr("ru = 'Не в списке';
										|en = 'Not in list';"));
