...
Procedure FillCheckProcessing(Cancel, CheckedAttributes)
	...
	If ValueIsFilled(EndDate) And EndDate < StartDate Then
		MessageText = NStr("ru = 'Дата окончания меньше даты начала. Скорее всего, дата окончания заполнена неверно.';
								|en = 'The end date is earlier than the start date. Probably the end date is incorrect.';");
