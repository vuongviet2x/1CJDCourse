...
Procedure FileSystemExtensionAttachedOwnerWorkingDirectorySelectionStartFollowUp(Result, AdditionalParameters) Export
	...
	Filter = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = 'Все файлы (%1)|%1';
																			|en = 'All files (%1)|%1';"), GetAllFilesMask());
	OpenFileDialog.Filter = Filter;
	OpenFileDialog.Multiselect = False;
	OpenFileDialog.Title = NStr("ru = 'Выберите папку';
										|en = 'Select folder';");
	If OpenFileDialog.Choose() Then
		...
		Except
			...
			ErrorText =
				StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = 'Неверный путь или отсутствуют права на запись в папку ""%1""';
																			|en = 'Invalid path or insufficient rights to save to folder ""%1""';"), DirectoryName);
