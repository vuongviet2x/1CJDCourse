...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Else
		...
		If Common.SubsystemExists("StandardSubsystems.ObjectAttributesLock") Then
			...
			ModuleObjectAttributesLock.LockAttributes(ThisObject,, NStr("ru = 'Разрешить редактирование типа и группы';
																									|en = 'Allow edit type and group';"));
...
Procedure BeforeWriteAtServer(Cancel, CurrentObject, WriteParameters)
	...
	If TheTypeOfCISWithThisNameAlreadyExists(CurrentObject) Then
		...
		Raise StringFunctionsClientServer.SubstituteParametersToString(
			NStr("ru = 'Вид контактной информации с наименованием %1 уже существует. Задайте другое наименование.';
				|en = 'Contact information kind with the %1 description already exists. Specify another description.';"),
...
Function IDForFormulasAlreadyUsed(Val IDForFormulas, Val CurrentContactInformationKind, Val Parent)
	...
	QueryText = NStr("ru = 'Существует вид контактной информации с идентификатором для формул
	                          |""%1"".
	                          |
	                          ...
	                          |
	                          |Создать новый идентификатор для формул и продолжить запись?';
								|en = 'A contact information kind with ID for formulas 
								|""%1"" already exists.
								|
