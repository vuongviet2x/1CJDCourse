...
Procedure ListBeforeAddRow(Item, Cancel, Copy, Parent, Var_Group)
	...
	If Copy And Var_Group Then
		...
		ShowMessageBox(, NStr("ru = 'Добавление новых групп в справочнике запрещено.';
										|en = 'Adding new groups to the catalog is prohibited.';"));
	EndIf;
...
Function ListFormName(ContactInformationKindRef)
	...
	Raise StringFunctionsClientServer.SubstituteParametersToString(
		NStr("ru = 'Невозможно перейти к списку %1';
			|en = 'Cannot go to the %1 list';"), ContactInformationKindRef);
