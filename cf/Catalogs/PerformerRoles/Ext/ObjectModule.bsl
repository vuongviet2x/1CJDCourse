...
Procedure FillCheckProcessing(Cancel, CheckedAttributes)
	...
	If Not UsedByAddressingObjects And Not UsedWithoutAddressingObjects Then
		Common.MessageToUser(
			NStr("ru = 'Не указаны допустимые способы назначения исполнителей на роль: совместно с объектами адресации, без них или обоими способами.';
				|en = 'The allowed methods for adding assignees to roles are not specified (together with business objects, without them, or both ways).';"),
	...
	If Not MainAddressingObjectTypesAreSet Then
		Common.MessageToUser(NStr("ru = 'Не указаны типы основного объекта адресации.';
													|en = 'Types of the main business object are not specified.';"),
