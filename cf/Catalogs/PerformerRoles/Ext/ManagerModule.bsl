...
Procedure OnInitialItemsFilling(LanguagesCodes, Items, TabularSections) Export
	...
	Else
		Item.Description = NStr("ru = 'Координатор выполнения задач';
									|en = 'Task control manager';", Common.DefaultLanguageCode());
	EndIf;
	...
	Item.Code                              = "000000001";
	Item.BriefPresentation             = NStr("ru = '000000001';
													|en = '000000001';", Common.DefaultLanguageCode());
