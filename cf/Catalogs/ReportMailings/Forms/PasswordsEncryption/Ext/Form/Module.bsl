...
Procedure PrepareItemVisibility(Archive)
	...
	If ReportMailing.CanEncryptAttachments() Then
		...
		Title = ?(Archive, NStr("ru = 'Пароли и шифрование для рассылки отчетов';
										|en = 'Passwords and encryption for report distribution';"), NStr(
	...
	Else
		...
		Items.PopulateCertificates.Visible   = False;
		Title = NStr("ru = 'Пароли для рассылки отчетов';
