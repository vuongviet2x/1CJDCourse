...
Procedure Fill(Command)
	If Server = "" Then
		FullAddress = NStr("ru = 'ftp://логин:пароль@сервер:порт/каталог/';
							|en = 'ftp://username:password@server:port/directory';");
	Else
		If Login = "" Then
	...
	ShowInputString(Handler, FullAddress, NStr("ru = 'Введите полный ftp адрес';
													|en = 'Enter full ftp address';"))
EndProcedure
