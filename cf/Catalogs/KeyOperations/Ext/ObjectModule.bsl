...
Procedure CheckPriority(Cancel)
	...
	If Selection.Next() Then
		MessageText = NStr("ru = 'Ключевая операция с приоритетом ""%1"" уже существует (%2).';
		...
		WriteLogEvent(NStr("ru = 'Оценка производительности';
										|en = 'Performance monitor';", Common.DefaultLanguageCode()),
