...
Procedure ApplySetsAndPropertiesAppearance()
	...
	AppearanceColorItem.Value = NStr("ru = 'Наборы';
											|en = 'Sets';");
...
Procedure ConfigureSetsDisplay()
	...
	If PropertyKind = Enums.PropertiesKinds.AdditionalInfo Then
		Title = NStr("ru = 'Дополнительные сведения';
						|en = 'Additional information records';");
		
		CreateButton.Title          = NStr("ru = 'Новое';
												|en = 'New item';");
		ButtonCreateContext.Title = NStr("ru = 'Новое';
													|en = 'New item';");
		CreateCommand.ToolTip         = NStr("ru = 'Создать уникальное сведение';
												|en = 'Create a unique information record.';");
		
		CopyCommand.ToolTip        = NStr("ru = 'Создать новое сведение копированием текущего';
													|en = 'Create an information record by copying the current one.';");
		ChangeCommand.ToolTip           = NStr("ru = 'Изменить (или открыть) текущее сведение';
													|en = 'Change or open the information record.';");
		MarkForDeletionCommand.ToolTip = NStr("ru = 'Пометить текущее сведение на удаление (Del)';
													|en = 'Mark the information record for deletion (Del).';");
		MoveUpCommand.ToolTip   = NStr("ru = 'Переместить текущее сведение вверх';
													|en = 'Move the information record up the list.';");
		MoveDownCommand.ToolTip    = NStr("ru = 'Переместить текущее сведение вниз';
													|en = 'Move the information record down the list.';");
		...
		Items.PropertiesValueType.ToolTip =
			NStr("ru = 'Типы значения, которое можно ввести при заполнении сведения.';
				|en = 'Available information record value types.';");
		
		Items.PropertiesCommonValues.ToolTip =
			NStr("ru = 'Сведение использует список значений сведения-образца.';
				|en = 'The information record inherits the master record''s list of values.';");
		
		Items.ShowUnusedAttributes.Title = NStr("ru = 'Показать неиспользуемые сведения';
																	|en = 'Show unused information records';");
		
		Items.PropertiesCommon.Title = NStr("ru = 'Общее';
												|en = 'Shared';");
		Items.PropertiesCommon.ToolTip = NStr("ru = 'Общее дополнительное сведение, которое используется в
		                                              |нескольких наборах дополнительных сведений.';
														|en = 'A shared additional information record.
														|It belongs to multiple sets.';");
	ElsIf PropertyKind = Enums.PropertiesKinds.Labels Then
		Title = NStr("ru = 'Метки';
						|en = 'Labels';");
		CreateButton.Title            = NStr("ru = 'Новая';
													|en = 'New item';");
		ButtonCreateContext.Title = NStr("ru = 'Новая';
													|en = 'New item';");
		CreateCommand.ToolTip          = NStr("ru = 'Создать уникальную метку';
												|en = 'Create a unique label';");
		
		CopyCommand.ToolTip        = NStr("ru = 'Создать новую метку копированием текущей';
													|en = 'Create a new label by copying the current label';");
		ChangeCommand.ToolTip           = NStr("ru = 'Изменить (или открыть) текущую метку';
													|en = 'Edit or open the current label';");
		MarkForDeletionCommand.ToolTip = NStr("ru = 'Пометить текущую метку на удаление (Del)';
													|en = 'Mark the current label for deletion (Del)';");
		MoveUpCommand.ToolTip   = NStr("ru = 'Переместить текущую метку вверх';
													|en = 'Move the current label up';");
		MoveDownCommand.ToolTip    = NStr("ru = 'Переместить текущую метку вниз';
													|en = 'Move the current label down';");
		...
		Items.PropertiesValueType.ToolTip =
			NStr("ru = 'Типы значения, которое можно ввести при заполнении метки.';
				|en = 'Types of a value that you can enter when filling a label.';");
		
		Items.PropertiesCommonValues.ToolTip =
			NStr("ru = 'Метка использует список значений метки-образца.';
				|en = 'The label uses the list of master label values.';");
		
		Items.ShowUnusedAttributes.Title = NStr("ru = 'Показать неиспользуемые метки';
																	|en = 'Show unused labels';");
		
		Items.PropertiesCommon.Title = NStr("ru = 'Общая';
												|en = 'Common';");
		Items.PropertiesCommon.ToolTip = NStr("ru = 'Общая метка, которая используется в
		                                              |нескольких наборах меток.';
														|en = 'A common label that is used in
														|several label sets.';");
		Items.Properties.Header = False;
		Items.PropertiesValueType.Visible = False;
	Else
		Title = NStr("ru = 'Дополнительные реквизиты';
						|en = 'Additional attributes';");
		CreateButton.Title            = NStr("ru = 'Новый';
													|en = 'New item';");
		ButtonCreateContext.Title = NStr("ru = 'Новый';
													|en = 'New item';");
		CreateCommand.ToolTip          = NStr("ru = 'Создать уникальный реквизит';
												|en = 'Create a unique attribute.';");
		
		CopyCommand.ToolTip        = NStr("ru = 'Создать новый реквизит копированием текущего';
													|en = 'Create an attribute by copying the current one.';");
		ChangeCommand.ToolTip           = NStr("ru = 'Изменить (или открыть) текущий реквизит';
													|en = 'Change or open the attribute.';");
		MarkForDeletionCommand.ToolTip = NStr("ru = 'Пометить текущий реквизит на удаление (Del)';
													|en = 'Mark the attribute for deletion (Del).';");
		MoveUpCommand.ToolTip   = NStr("ru = 'Переместить текущий реквизит вверх';
													|en = 'Move the attribute up the list.';");
		MoveDownCommand.ToolTip    = NStr("ru = 'Переместить текущий реквизит вниз';
													|en = 'Move the attribute down the list.';");
		...
		Items.PropertiesValueType.ToolTip =
			NStr("ru = 'Типы значения, которое можно ввести при заполнении реквизита.';
				|en = 'Available attribute value types.';");
		
		Items.PropertiesCommonValues.ToolTip =
			NStr("ru = 'Реквизит использует список значений реквизита-образца.';
				|en = 'The attribute inherits the master attribute''s list of values.';");
		
		Items.ShowUnusedAttributes.Title = NStr("ru = 'Показать неиспользуемые реквизиты';
																	|en = 'Show unused attributes';");
		
		Items.PropertiesCommon.Title = NStr("ru = 'Общий';
												|en = 'Shared';");
		Items.PropertiesCommon.ToolTip = NStr("ru = 'Общий дополнительный реквизит, который используется в
		                                              |нескольких наборах дополнительных реквизитов.';
														|en = 'A shared additional attribute.
														|It belongs to multiple sets.';");
	EndIf;
...
Procedure ChangeDeletionMark()
	...
	If Items.Properties.CurrentData <> Undefined Then
		...
		If PropertyKind = PredefinedValue("Enum.PropertiesKinds.AdditionalInfo") Then
			If Not ShowUnusedAttributes Then
				QueryText = NStr("ru = 'Исключить сведение из набора?';
									|en = 'Do you want to remove the information record from the set?';");
				
			ElsIf Items.Properties.CurrentData.DeletionMark Then
				QueryText = NStr("ru = 'Снять с текущего сведения пометку на удаление?';
									|en = 'Do you want to clear the deletion mark from the information record?';");
			Else
				QueryText = NStr("ru = 'Пометить текущее сведение на удаление?';
									|en = 'Do you want to mark the information record for deletion?';");
			EndIf;
		ElsIf PropertyKind = PredefinedValue("Enum.PropertiesKinds.AdditionalAttributes") Then
			If Not ShowUnusedAttributes Then
				QueryText = NStr("ru = 'Исключить реквизит из набора?';
									|en = 'Do you want to remove the attribute from the set?';");
				
			ElsIf Items.Properties.CurrentData.DeletionMark Then
				QueryText = NStr("ru = 'Снять с текущего реквизита пометку на удаление?';
									|en = 'Do you want to clear the deletion mark from the attribute?';");
			Else
				QueryText = NStr("ru = 'Пометить текущий реквизит на удаление?';
									|en = 'Do you want to mark the attribute for deletion?';");
			EndIf;
		ElsIf PropertyKind = PredefinedValue("Enum.PropertiesKinds.Labels") Then
			If Not ShowUnusedAttributes Then
				QueryText = NStr("ru = 'Исключить метку из набора?';
									|en = 'Do you want to remove the label from the set?';");
				
			ElsIf Items.Properties.CurrentData.DeletionMark Then
				QueryText = NStr("ru = 'Снять с текущей метки пометку на удаление?';
									|en = 'Do you want to unmark the label for deletion?';");
			Else
				QueryText = NStr("ru = 'Пометить текущую метку на удаление?';
									|en = 'Do you want to mark the label for deletion?';");
			EndIf;
		EndIf;
	...
	Try
		...
		Try
			...
			If CurrentSetObject.DataVersion <> CurrentSetDataVersion Then
					...
					Raise
						NStr("ru = 'Действие не выполнено, так как состав дополнительных сведений
						           ...
						           |Повторите действие, если требуется.';
									|en = 'The action is not performed as the set of information records
				...
				ElsIf PropertyKind = Enums.PropertiesKinds.AdditionalAttributes Then
					Raise
						NStr("ru = 'Действие не выполнено, так как состав дополнительных реквизитов
						           ...
						           |
						           |Повторите действие, если требуется.';
									|en = 'The action is not performed as the set of additional attributes
									|has been changed by another user.
				...
				ElsIf PropertyKind = Enums.PropertiesKinds.Labels Then
					Raise
						NStr("ru = 'Действие не выполнено, так как состав меток
						           |был изменен другим пользователем.
						           |Новый состав меток прочитан.
						           |
						           |Повторите действие, если требуется.';
									|en = 'The action is not performed as the set of labels
									|has been changed by another user.
