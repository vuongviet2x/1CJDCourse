...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If UseAddlInfo And Not UseAddlAttributes And Not UseLabels Then
		Title = Object.Description + " " + NStr("ru = '(Набор дополнительных сведений)';
													|en = '(Set of additional information records)';")
	ElsIf UseLabels And Not UseAddlInfo And Not UseAddlAttributes Then
		Title = Object.Description + " " + NStr("ru = '(Набор меток)';
													|en = '(Label set)';")
	ElsIf UseAddlAttributes And Not UseAddlInfo And Not UseLabels Then
		Title = Object.Description + " " + NStr("ru = '(Набор дополнительных реквизитов)';
													|en = '(Set of additional attributes)';")
	Else
		Title = Object.Description + " " + NStr("ru = '(Набор дополнительных свойств)';
													|en = '(Set of additional properties)';")
	EndIf;
