...
Procedure BeforeWrite(Cancel)
	...
	If Common.DataSeparationEnabled() Then
		Raise NStr("ru = 'Настройка варианта обновления классификаторов не доступна при работе в модели сервиса.
			|Загрузка обновлений выполняется подсистемой ""Поставляемые данные"".';
			|en = 'Cannot set up classifier update in SaaS.
...
Procedure OnWrite(Cancel)
	...
	ClassifiersOperations.SetScheduledJobsUsage(Value <> 0);
