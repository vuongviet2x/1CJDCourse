...
Function CanRequestForPermissionsToUseExternalResources()
	...
	Else
		...
		If Not Users.IsFullUser() Then
			Raise(NStr("ru = 'Недостаточно прав доступа для запроса разрешений на использование внешних ресурсов.';
									|en = 'Insufficient access rights to request permissions to use external resources.';"),
