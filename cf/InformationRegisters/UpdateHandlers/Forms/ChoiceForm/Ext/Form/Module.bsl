...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	Title = NStr("ru = 'Выбор обработчиков для перезапуска отложенного обновления';
					|en = 'Select handlers for deferred update restart';");
...
#Region FormTableItemsEventHandlersHandlerList
