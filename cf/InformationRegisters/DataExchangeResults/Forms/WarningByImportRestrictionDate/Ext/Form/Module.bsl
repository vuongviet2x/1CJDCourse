...
Procedure AcceptVersionDeclined(Command)
	...
	QueryText = NStr("ru = 'Принять версию, несмотря на запрет загрузки?';
						|en = 'Do you want to accept the version even though import is restricted?';", CommonClient.DefaultLanguageCode());
