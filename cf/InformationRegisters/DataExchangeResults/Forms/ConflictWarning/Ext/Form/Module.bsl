...
Procedure ShowDifferences(Command)
	...
	If ThisApplicationVersion = 0
		...
		CommonClient.MessageToUser(NStr("ru = 'Для сравнения должно быть две версии объекта.';
														|en = 'There must be two object versions for comparison.';"), CommonClient.DefaultLanguageCode());
		Return;
...
Procedure AcceptRejectVersionAtServer(ErrorMessage)
	...
	Except
		...
		TextTemplate1			= NStr("ru = 'Не удалось принять версию объекта ""%1"" по причине:%2 %3.';
										|en = 'Cannot accept the object version ""%1"" due to:%2 %3.';", Common.DefaultLanguageCode());
