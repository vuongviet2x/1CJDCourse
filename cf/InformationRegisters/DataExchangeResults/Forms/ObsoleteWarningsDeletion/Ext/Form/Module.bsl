...
Procedure DeleteWarningsInALongOperation()
	...
	ExecutionParameters.BackgroundJobDescription = NStr("ru = 'Удаление предупреждений синхронизации';
															|en = 'Delete synchronization warnings';", Common.DefaultLanguageCode());
