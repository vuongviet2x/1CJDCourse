...
Procedure AcceptVersion(Command)
	...
	QueryText = NStr("ru = 'Принять версии в отмеченных строках, несмотря на запрет загрузки?';
						|en = 'Accept versions in the selected lines even though import is restricted?';", CommonClient.DefaultLanguageCode());
