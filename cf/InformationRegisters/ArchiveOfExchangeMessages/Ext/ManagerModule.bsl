...
Procedure PutToArchive(InfobaseNode, PathToSourceFile, Settings)
	...
	Else
		...
		If Common.DataSeparationEnabled() And FileSize > 100 Then
			...
			Cause = NStr("ru = 'Сообщение обмена больше 100 Мб. Файл не был помещен в архив.';
							|en = 'Exchange message larger than 100 MB. The file is not placed to the archive.';");
...
Function EventLogEventMessagePutToArchive()
	...
	Return NStr("ru = 'Обмен данными.Помещение сообщения в архив';
				|en = 'Data exchange.Place message to archive';", Common.DefaultLanguageCode());
