...
Procedure SetConditionalAppearance()
	...
	ApplyDataGroupAppearance(0, NStr("ru = 'Стандартные значения доступа';
								|en = 'Standard Access Values';"));
	ApplyDataGroupAppearance(1, NStr("ru = 'Обычные/внешние пользователи';
								|en = 'Regular or external users';"));
	ApplyDataGroupAppearance(2, NStr("ru = 'Обычные/внешние группы пользователей';
								|en = 'Regular or external user groups';"));
	ApplyDataGroupAppearance(3, NStr("ru = 'Группы исполнителей';
								|en = 'Assignee groups';"));
	ApplyDataGroupAppearance(4, NStr("ru = 'Объекты авторизации';
