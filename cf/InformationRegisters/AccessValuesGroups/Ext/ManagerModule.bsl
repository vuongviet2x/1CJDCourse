...
Function ErrorTextTypeNotConfigured(AccessValueType)
	...
	ErrorTitle =
		NStr("ru = 'Ошибка при обновлении групп значений доступа.';
			|en = 'An error occurred when updating Access Value Groups.';")
		+ Chars.LF
		+ Chars.LF;
