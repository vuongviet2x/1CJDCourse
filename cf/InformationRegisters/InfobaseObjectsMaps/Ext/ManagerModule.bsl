...
Procedure AddRecord(RecordStructure, Load = False) Export
	...
	For Each AttributeToCheck In CheckedAttributes Do
		If RecordStructure.Property(AttributeToCheck)
			...
			EventDescription1 = NStr("ru = 'Добавление записи регистра сведений ""Соответствия объектов информационных баз""';
									|en = 'Add a record to the ""Mapping of infobase objects"" information register';",
				Common.DefaultLanguageCode());
			Comment     = NStr("ru = 'Не заполнен реквизит %1. Создание записи регистра невозможно.';
									|en = 'Attribute %1 is not filled in. Cannot create the register record.';");
