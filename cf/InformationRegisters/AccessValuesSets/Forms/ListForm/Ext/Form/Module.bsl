...
Procedure SetConditionalAppearance()
	...
	AppearanceItem.Appearance.SetParameterValue("Text", NStr("ru = 'Проверка права Чтение';
																			|en = 'Check Read right';"));
	...
	AppearanceItem.Appearance.SetParameterValue("Text", NStr("ru = 'Проверка права Изменение';
																			|en = 'Check Update right';"));
