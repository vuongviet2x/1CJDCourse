...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Parameters.Filter.Property("Application") 
	   And ValueIsFilled(Parameters.Filter.Application) Then
		...
		AutoTitle = False;
		Title = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = 'Пути к программе %1 на серверах Linux';
																				|en = 'Paths to application %1 on Linux servers';"), Application);
