...
Procedure UpdateTemplatesCheckSum(Parameters) Export
	...
	If ValueIsFilled(TemplatesRequiringChecksumUpdate) Then
		ErrorList.Insert(0, NStr("ru = 'Не удалось записать сведения о макетах печатных форм расширений:';
										|en = 'Couldn''t save the template details of print forms stored in extensions:';"));
