...
Procedure BeforeWrite(Cancel, WriteParameters)
	...
	If (Object.StartDate > Object.EndDate) And (Object.EndDate <> Date(1,1,1)) Then
		...
		CommonClient.MessageToUser(NStr("ru = 'Дата начала не может быть больше чем дата окончания.';
														|en = 'The start date cannot be greater than end date.';"),,"Object.StartDate");
		Cancel = True;
...
#Region FormTableItemsEventHandlersRespondents
