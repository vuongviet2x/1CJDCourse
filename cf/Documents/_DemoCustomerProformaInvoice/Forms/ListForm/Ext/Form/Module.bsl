...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	CanBeEdited = AccessRight("Edit", Metadata.Documents._DemoCustomerProformaInvoice);
	...
	If Common.IsMobileClient() Then
		Items.DateNumber.Group = ColumnsGroup.Vertical;
		Items.PartnerCompany.Group = ColumnsGroup.Vertical;
	EndIf;
