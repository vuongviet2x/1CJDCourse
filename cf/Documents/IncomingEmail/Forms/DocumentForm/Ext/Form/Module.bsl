...
Procedure ReviewedOnChange(Item)
	...
	If Reviewed And ReadReceiptRequestRequired Then
		...
		ShowQueryBox(OnCloseNotifyHandler,
		       NStr("ru = 'Отправитель запросил уведомление о прочтении. Отправить?';
					|en = 'Sender has requested a read receipt. Do you want to send a receipt?';"),
		       QuestionDialogMode.YesNo,
		       ,
		       DialogReturnCode.Yes,
		       NStr("ru = 'Запрос уведомления';
					|en = 'Read receipt request';"));
...
Procedure ChangeEncoding(Command)
	...
	EncodingsList.ShowChooseItem(OnCloseNotifyHandler,
		NStr("ru = 'Выберите кодировку';
			|en = 'Select encoding';"), EncodingsList.FindByValue(Lower(Object.Encoding)));
...
Procedure FillAdditionalInformation()
	...
	AdditionalInformationAboutEmail = NStr("ru = 'Создано:';
											|en = 'Created on:';") + "   " + Object.Date 
	+ Chars.LF + NStr("ru = 'Получено';
						|en = 'Received';") + ":  " + Object.DateReceived 
	+ Chars.LF + NStr("ru = 'Важность';
						|en = 'Importance';") + ":  " + Object.Importance
	+ Chars.LF + NStr("ru = 'Кодировка';
						|en = 'Encoding';") + ": " + Object.Encoding;
