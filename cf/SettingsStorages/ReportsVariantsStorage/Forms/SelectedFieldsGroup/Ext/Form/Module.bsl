...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not Parameters.Property("Placement", Placement) Then
		Raise NStr("ru = 'Не передан служебный параметр ""Расположение"".';
								|en = 'Location service parameter has not been passed.';");
	EndIf;
	...
	Else
		Raise StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = 'Некорректное значение параметра ""Расположение"": ""%1"".';
																						|en = 'Location parameter contains invalid value: %1.';"), String(Placement));
	EndIf;
EndProcedure
