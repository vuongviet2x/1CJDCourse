...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not OnAuthorization Then
		...
		Items.FormCloseForm.Title = NStr("ru = 'Отмена';
													|en = 'Cancel';");
		
	ElsIf Not PasswordIsSet Then
		Items.AuthorizationNote.Title =
			NStr("ru = 'Для входа в приложение установите пароль.';
				|en = 'To log in, set a password.';")
	EndIf;
	...
	If Not IsCurrentIBUser
	 Or Not PasswordIsSet Then
		...
		AutoTitle = False;
		Title = NStr("ru = 'Установка пароля';
						|en = 'Set password';");
...
Procedure SetPassword(Command)
	...
	If Not ShowNewPassword And NewPassword <> Confirmation Then
		...
		ShowMessageBox(, NStr("ru = 'Подтверждение пароля указано некорректно.';
