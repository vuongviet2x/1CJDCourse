...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not Users.IsFullUser() Then
		...
		Raise NStr("ru = 'Недостаточно прав для настройки автономной работы.';
								|en = 'Insufficient rights for standalone mode setup.';");
		
	ElsIf Not StandaloneModeInternal.StandaloneModeSupported() Then
		
		Raise NStr("ru = 'Возможность автономной работы в программе не предусмотрена.';
								|en = 'Standalone mode is unavailable in the application.';");
...
Procedure HowToConfigureStandaloneWorkstation(Command)
	...
	FormParameters.Insert("Title", NStr("ru = 'Как настроить автономное рабочее место';
												|en = 'How to set up a standalone workstation';"));
