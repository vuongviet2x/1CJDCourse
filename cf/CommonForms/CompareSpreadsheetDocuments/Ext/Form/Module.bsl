...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Common.IsMobileClient() Then
		Cancel = True;
		Raise NStr("ru = 'Операция не доступна в мобильном клиенте, используйте тонкий клиент.';
								|en = 'The operation is not available in the mobile client. Use the thin client.';");
	EndIf;
