...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Surveys.SetQuestionnaireSectionsTreeItemIntroductionConclusion(SectionsTree, NStr("ru = 'Вступление';
																								|en = 'Introduction';"), "Introduction");
	Surveys.FillSectionsTree(ThisObject,SectionsTree);
	Surveys.SetQuestionnaireSectionsTreeItemIntroductionConclusion(SectionsTree, NStr("ru = 'Заключение';
...
Procedure ChangeSectionsTreeVisibility()
	...
	Items.HideSections.Title = ?(Items.SectionsTreeGroup.Visible,NStr("ru = 'Скрыть разделы';
																						|en = 'Hide sections';"), NStr("ru = 'Показать разделы';
																													|en = 'Show sections';"));
