...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not IsCustomSettings Then 
		Items.FormOK.Title = NStr("ru = 'Сохранить';
											|en = 'Save';");
	EndIf;
...
Procedure DefineBehaviorInMobileClient()
	...
	Items.TopLeftText.InputHint = NStr("ru = 'Слева сверху';
													|en = 'Top left';");
	Items.TopMiddleText.InputHint = NStr("ru = 'В центре сверху';
														|en = 'Top center';");
	Items.TopRightText.InputHint = NStr("ru = 'Справа сверху';
													|en = 'Top right';");
	
	Items.BottomLeftText.InputHint = NStr("ru = 'Слева снизу';
													|en = 'Bottom left';");
	Items.BottomCenterText.InputHint = NStr("ru = 'В центре снизу';
													|en = 'Bottom center';");
	Items.BottomRightText.InputHint = NStr("ru = 'Справа снизу';
													|en = 'Bottom right';");
...
Procedure PreparePreview()
	...
	Pattern.Area(3, 2).Text      = Chars.LF + NStr("ru = 'Образец отчета';
														|en = 'Report preview';") + Chars.LF + " ";
...
Function FillTemplate(Template, HomePage)
	...
	Else
		...
		Result = StrReplace(Result, "[&ReportTitle]", NStr("ru = 'Стандартный отчет';
																	|en = 'Standard report';"));
