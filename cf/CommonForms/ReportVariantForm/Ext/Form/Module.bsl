...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If ValueIsFilled(Parameters.VariantPresentation) Then
		AutoTitle = False;
		Title = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = 'Изменение варианта отчета ""%1""';
																				|en = 'Modify ""%1"" report option';"), Parameters.VariantPresentation);
	EndIf;
...
#Region FormTableItemsEventHandlersOutputParameters
