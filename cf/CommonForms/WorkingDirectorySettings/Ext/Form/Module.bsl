...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Common.IsMobileClient() Then
		...
		Items.CleanUpWorkingDirectory.Title = NStr("ru = 'Очистить';
														|en = 'Clear working directory';");
...
Procedure UserWorkingDirectoryStartChoice(Item, ChoiceData, StandardProcessing)
	...
	Title = NStr("ru = 'Выберите рабочий каталог';
...
Procedure CleanUpLocalFileCacheCompletion(Result, ExecutionParameters) Export
	...
	ShowUserNotification(NStr("ru = 'Рабочий каталог';
										|en = 'Working directory';"),, NStr("ru = 'Очистка рабочего каталога успешно завершена.';
																		|en = 'The working directory is cleared.';"));
