...
Function ImportDataToInfobase(FileID, BackgroundJobIdentifier, ErrorMessage)
	...
	ExecutionParameters.BackgroundJobDescription = NStr("ru = 'Загрузка данных в информационную базу через web-сервис ""Enterprise Data Upload""';
															|en = 'Import data to the infobase using the ""Enterprise Data Upload"" web service';");
